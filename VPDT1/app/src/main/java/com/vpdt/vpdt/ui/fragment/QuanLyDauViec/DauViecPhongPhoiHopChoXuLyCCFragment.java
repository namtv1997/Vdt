...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecPhongPhoiHopChoXuLyCC;
...
public class DauViecPhongPhoiHopChoXuLyCCFragment extends BaseFragment<DauViecPhongChuTriChoXuLyCCPresenter> implements DauViecPhongChuTriChoXuLyCCView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDauViecPhongPhoiHopChoXuLyCC.OnItemXemFileClickListener {
    ...
    AdapterDauViecPhongPhoiHopChoXuLyCC adapterDanhSachDauViecQuaHanCuaPhong;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_phong_phoi_hop_cho_xu_ly_cc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongPhoHopChoXuLyCC(NamLamViec, true);
    ...
    public void onGetPhoiHopSuccess(ArrayList<DauViecPhongPhoiHopChoXuLyCC> dauViecPhongPhoiHopChoXuLyCCArrayList) {
        adapterDanhSachDauViecQuaHanCuaPhong = new AdapterDauViecPhongPhoiHopChoXuLyCC(getActivity(), dauViecPhongPhoiHopChoXuLyCCArrayList, this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerview.setLayoutManager(layoutManager);
        recyclerview.setAdapter(adapterDanhSachDauViecQuaHanCuaPhong);
        if (dauViecPhongPhoiHopChoXuLyCCArrayList.size() == 0) {
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongPhoHopChoXuLyCC(String.valueOf(integer), true);
    ...
    @Override
    public void onItemClickXemFile(DauViecPhongPhoiHopChoXuLyCC dauViecPhongPhoiHopChoXuLyCC) {
        try {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(dauViecPhongPhoiHopChoXuLyCC.getUrlFile()));
