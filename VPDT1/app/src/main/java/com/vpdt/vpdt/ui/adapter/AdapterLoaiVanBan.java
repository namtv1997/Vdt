...
public class AdapterLoaiVanBan extends RecyclerView.Adapter<AdapterLoaiVanBan.ViewHolder> {
    private ArrayList<KhuVuc> khuVucArrayList;
    private OnItemLoaiVanBanClickListener listener;

    public AdapterLoaiVanBan(ArrayList<KhuVuc> khuVucArrayList, OnItemLoaiVanBanClickListener listener) {
    ...
    public interface OnItemLoaiVanBanClickListener {
        void onItemLoaiVanBanClick(KhuVuc khuVuc);
    }
}
