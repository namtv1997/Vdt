...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecChoXuLy1;
...
public class DauViecChoXuLyFragment extends BaseFragment<DauViecChoXuLyPresenter> implements DauViecChoXuLyView,
        AdapterDauViecChoXuLy1.OnItemXemFileClickListener, AdapterNamLamViec.OnItemClickListenerNamLamViec {
    ...
    private AdapterDauViecChoXuLy1 adapterDauViecChoXuLy;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_cho_xu_ly;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getalldauviec(NamLamViec, 1, true);
//        getPresenter().countalldauviec(NamLamViec, 1);

        adapterDauViecChoXuLy = new AdapterDauViecChoXuLy1(getActivity(), getPresenter().DAU_VIEC_CHO_XU_LY_ARRAY_LIST(), this);
...
//                getPresenter().countalldauviec(NamLamViec, 1);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getalldauviec(NamLamViec, 1, false);
//                getPresenter().countalldauviec(NamLamViec, 1);
    ...
    @OnClick({R.id.btnNamLamViec, R.id.btnBack, R.id.vDVCXL, R.id.lnDVCXL, R.id.rlDVCXL, R.id.btnHome})
...
//                break;
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getalldauviec(String.valueOf(integer), 1, true);
//        getPresenter().countalldauviec(String.valueOf(integer), 1);
