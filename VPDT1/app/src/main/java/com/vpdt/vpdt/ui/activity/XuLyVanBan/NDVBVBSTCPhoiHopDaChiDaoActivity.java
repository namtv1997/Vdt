...
public class NDVBVBSTCPhoiHopDaChiDaoActivity extends BaseActivity<NDVBVBSTCPhoiHopDaChiDaoPresenter> implements NDVBVBSTCPhoiHopDaChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvbstcphoi_hop_da_chi_dao;
    }
    ...
    public void initializeComponents() {
        ...
        if (phongChuTriDaChiDao != null) {
            ...
            if (phongChuTriDaChiDao.getHanGiaiQuyet().equals("01/01/1970")) {
                tvNgayThangNamNDVBDSVBDenChoLDXL.setText("");
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVBSTCPhoiHopDaChiDaoActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnChonPhoPhong:
                ...
                imgCancephophong.setOnClickListener(v -> dialog.dismiss());
