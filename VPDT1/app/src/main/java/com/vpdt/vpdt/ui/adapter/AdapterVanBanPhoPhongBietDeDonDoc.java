...
public class AdapterVanBanPhoPhongBietDeDonDoc extends RecyclerView.Adapter<AdapterVanBanPhoPhongBietDeDonDoc.ViewHolder> {
    private ArrayList<VanBanPhoPhongBietDeDonDoc> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanPhoPhongBietDeDonDoc(ArrayList<VanBanPhoPhongBietDeDonDoc> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanPhoPhongBietDeDonDoc giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        if (giaHanGiaiQuyet.getlo().isEmpty() || giaHanGiaiQuyet.getLoaiVanBan() == null) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanPhoPhongBietDeDonDoc vanBanPhoPhongBietDeDonDoc);

        void onItemClickXuLy(VanBanPhoPhongBietDeDonDoc vanBanPhoPhongBietDeDonDoc);

        void onItemClickXemChiTiet(VanBanPhoPhongBietDeDonDoc vanBanPhoPhongBietDeDonDoc);
    }
}
