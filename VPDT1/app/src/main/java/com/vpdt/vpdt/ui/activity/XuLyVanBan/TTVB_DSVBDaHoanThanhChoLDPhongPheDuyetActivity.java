...
public class TTVB_DSVBDaHoanThanhChoLDPhongPheDuyetActivity extends BaseActivity<TTVB_DSVBDaHoanThanhChoLDPhongPheDuyetPresenter>
        implements TTVB_DSVBDaHoanThanhChoLDPhongPheDuyetView, AdapterTepTinDinhKemPhongPH.OnItemClickListener,
        AdapterFileVanBanLienQuanChoLanhDaoPhongPheDuyet.OnItemClickListenerFileVanBanLienQuanChoLanhDaoPhongPheDuyet,
        AdapterKetQuaGiaiQuyetPhongPheDuyet.OnItemketquaGiaiquyetClickListener {
    ...
    @BindView(R.id.cbVBQPPLTTVBDuyetDSVBGiaHanGiaiQuyet)
    CheckBox cbVBQPPLTTVBDuyetDSVBGiaHanGiaiQuyet;
    @BindView(R.id.cbSTCChuTriTTVBDuyetDSVBGiaHanGiaiQuyet)
    CheckBox cbSTCChuTriTTVBDuyetDSVBGiaHanGiaiQuyet;
    @BindView(R.id.cbTBKLTTVBDuyetDSVBGiaHanGiaiQuyet)
    CheckBox cbTBKLTTVBDuyetDSVBGiaHanGiaiQuyet;
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvb__dsvbda_hoan_thanh_cho_ldphong_phe_duyet;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("id_vb")) {
                idvb = intent.getIntExtra("id_vb", 0);
                getPresenter().getDetailVBQuaTrinhXuLy(idvb);
            }
        }
    }
    ...
    @OnClick({R.id.btnBack, R.id.tvThongTinVanBan,
            ...
            R.id.tvFileVanBanLienQuan, R.id.tvKetQuaGiaiQuyet})
    ...
    public void onGetDaTaSuccess(DetailVanBanChoLanhDaoPhongPheDuyet detailVanBanChoLanhDaoPhongPheDuyet) {
        ...
        if (detailVanBanChoLanhDaoPhongPheDuyet.getSTCCT() == 1) {
            cbSTCChuTriTTVBDuyetDSVBGiaHanGiaiQuyet.setChecked(true);
        }
        if (detailVanBanChoLanhDaoPhongPheDuyet.getTBKL() == 1) {

            cbTBKLTTVBDuyetDSVBGiaHanGiaiQuyet.setChecked(true);
        }
        if (detailVanBanChoLanhDaoPhongPheDuyet.getVBQPPL() == 1) {
            cbVBQPPLTTVBDuyetDSVBGiaHanGiaiQuyet.setChecked(true);
        }
