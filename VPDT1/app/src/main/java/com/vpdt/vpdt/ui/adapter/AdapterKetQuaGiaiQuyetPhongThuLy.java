...
public class AdapterKetQuaGiaiQuyetPhongThuLy extends RecyclerView.Adapter<AdapterKetQuaGiaiQuyetPhongThuLy.ViewHolder> {

    private ArrayList<KetquaGiaiquyetPhongThuly> ketquaGiaiquyetPhongThulyArrayList;
    private Context mContext;
    private OnItemketquaGiaiquyetPhongThulyClickListener listener;

    public AdapterKetQuaGiaiQuyetPhongThuLy(Context mContext, ArrayList<KetquaGiaiquyetPhongThuly> ketquaGiaiquyetPhongThulyArrayList,
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        KetquaGiaiquyetPhongThuly ketquaGiaiquyetPhongPhoihop = ketquaGiaiquyetPhongThulyArrayList.get(position);
    ...
    public interface OnItemketquaGiaiquyetPhongThulyClickListener {
        void onItemketquaGiaiquyetPhongThulyClick(KetquaGiaiquyetPhongThuly ketquaGiaiquyetPhongThuly);
    }
}
