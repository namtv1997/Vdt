...
import com.vpdt.vpdt.presenter.impl.ThongKeVanBanTheoPGDPresenterImpl;
...
public class ThongKeVanBanTheoPGDFragment extends BaseFragment<ThongKeVanBanTheoPGDPresenter> implements ThongKeVanBanTheoPGDView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_thong_ke_van_ban_theo_pgd;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getThongKeTheoPhoGiamDoc(NamLamViec, tvNgayNhap.getText().toString(), tvDenNgay.getText().toString());
    ...
    @Override
    public ThongKeVanBanTheoPGDPresenter createPresenter() {
        return new ThongKeVanBanTheoPGDPresenterImpl(this);
    }
    ...
    public void onItemClick(ThongKeTheoPhong thongKeTheoPhong) {
        ThongKeVanBanTheoPhongFragment fragment2 = new ThongKeVanBanTheoPhongFragment();
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.fl, fragment2);
        fragmentTransaction.addToBackStack("ThongKeVanBanTheoPhong");
