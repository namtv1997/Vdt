...
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NoiDungVanBanGiaoPhongChoXuLyActivity;
...
public class VanBanGiaoPhongChuChiChoXuLyFragment extends BaseFragment<VanBanGiaoPhongChuChiChoXuLyPresenter> implements VanBanGiaoPhongChuChiChoXuLyView,
    ...
    @OnClick({R.id.btnNamLamViecChoXuLy, R.id.btnBackChoXuLy,
            R.id.vcldxl, R.id.rlcldxl, R.id.rlcldxl1, R.id.lncldxl})
    ...
    public void onItemClickXuLy(PhongChuTriChoXL phongChuTri) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NoiDungVanBanGiaoPhongChoXuLyActivity.class);
