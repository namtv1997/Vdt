...
public class NDVBDauViecPhongPhoiHopChoXuLyTPCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyTPCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyViewTPCC,
    ...
    //    String idChuyenVienPhoiHops = "",tenChuyenvienPhoiHop;
    AlertDialog dialog;
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_phong_phoi_hop_cho_xu_ly_tpcc;
    }
    ...
    public void initializeComponents() {
        ...
        ItemDauViecPhongChuTriChoXuLyTCC itemDanhSachDauViecQuaHanCuaPhong = getIntent().getParcelableExtra("itemDauViecPhongChuTriChoXuLyTCC");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvNgayThangNam:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongPhoHopChoXuLyTPCC(PrefUtil.getString(NDVBDauViecPhongPhoiHopChoXuLyTPCCActivity.this, Key.NAM_LAM_VIEC, ""),
