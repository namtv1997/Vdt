...
import com.vpdt.vpdt.presenter.NDVBDauViecPhongPhoiHopChoXuLyPresenter;
import com.vpdt.vpdt.presenter.NDVBDauViecPhongPhoiHopChoXuLyView;
import com.vpdt.vpdt.presenter.impl.NDVBDauViecPhongPhoiHopChoXuLyPresenterImpl;
...
public class NDVBDauViecPhongPhoiHopChoXuLyActivity extends BaseActivity<NDVBDauViecPhongPhoiHopChoXuLyPresenter> implements NDVBDauViecPhongPhoiHopChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_phong_phoi_hop_cho_xu_ly;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                if (level == 7) {
                    getPresenter().duyetDauViecPhongPhoHopChoXuLy(id, 0, "", "", "", idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                } else {
                    getPresenter().duyetDauViecPhongPhoHopChoXuLy(id, idPhoPhong, tenPhoPhong, idPhoPhongPhoiHop, tenPhoPhongPhoiHop, idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                }
    ...
    @Override
    public NDVBDauViecPhongPhoiHopChoXuLyPresenter createPresenter() {
        return new NDVBDauViecPhongPhoiHopChoXuLyPresenterImpl(this);
    }
