...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecTruongPhongPhoiHopPhongCTTPCCActivity;
...
public class AdapterDauViecTruongPhongPhoiHopPhongCTTPCC extends RecyclerView.Adapter<AdapterDauViecTruongPhongPhoiHopPhongCTTPCC.ViewHolder> implements AdapterDauViecPhongChuTriChoXuLyTPCC1.OnItemClickListener {
    ...
    public AdapterDauViecTruongPhongPhoiHopPhongCTTPCC(Context context, ArrayList<DauViecPhongChuTriChoXuLyTPCC> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC) {
        Intent intent = new Intent(context, NDVBDauViecTruongPhongPhoiHopPhongCTTPCCActivity.class);
