...
public class NoiDungVanBanGiaoPhongChoXuLyPresenterImpl extends BasePresenterImpl<NoiDungVanBanGiaoPhongChoXuLyView> implements NoiDungVanBanGiaoPhongChoXuLyPresenter {
    public NoiDungVanBanGiaoPhongChoXuLyPresenterImpl(NoiDungVanBanGiaoPhongChoXuLyView view) {
        super(view);
    }
    ...
    @Override
    public void duyetVBPhongChuTriChoXuLy(int id, int idPhoPhong, String idPhoPhongPhoiHops,
                                          int idChuyenVien, String idChuyenVienPhoiHops,
                                          String chiDao, String chiDaoChuTri, boolean luuvanBan,
                                          boolean vanBanQuanTrong, boolean phoGiamDocDonDoc,
                                          String hanGiaiQuyet) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetVBPhongChuTriChoXuLy(token, id, idPhoPhong, idPhoPhongPhoiHops,
                idChuyenVien, idChuyenVienPhoiHops, chiDao, chiDaoChuTri,
                luuvanBan, vanBanQuanTrong, phoGiamDocDonDoc, hanGiaiQuyet, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
    ...
    @Override
    public void tuChoiVBPhongChuTriChoXuLy(int id, String noiDungTuChoi, String ghiChu) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().tuChoiVBPhongChuTriChoXuLy(token, id, noiDungTuChoi, ghiChu, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    @Override
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        Util.getIns().hideLoadding();
                        if (booleanResponse.getData()) {
                            getView().tuChoiVBPhongChuTriChoXuLySuccess();
                        } else {
                            Util.showMessenger(booleanResponse.getMessage(), getView().gContext());
                        }
                    }
    ...
    @Override
    public void tuChoiTPVBPhongChuTriChoXuLy(String nam, int id, String noiDungTuChoi, String ghiChu) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().tuChoiTPVBPhongChuTriChoXuLy(token, nam, id, noiDungTuChoi, ghiChu)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    @Override
