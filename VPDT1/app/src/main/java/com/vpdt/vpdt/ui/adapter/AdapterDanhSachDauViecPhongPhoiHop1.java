...
public class AdapterDanhSachDauViecPhongPhoiHop1 extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongPhoiHop1.ViewHolder> {
    private ArrayList<ItemDauViec> itemDauViecArrayList;
    private Context mContext;
    private OnItemClickListener listener;


    public AdapterDanhSachDauViecPhongPhoiHop1(Context mContext, ArrayList<ItemDauViec> itemDauViecArrayList, OnItemClickListener listener) {
        this.mContext = mContext;
        this.itemDauViecArrayList = itemDauViecArrayList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViec giaHanGiaiQuyet = itemDauViecArrayList.get(position);
...
//        }
        ...
        viewHolder.btnXemFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (itemDauViecArrayList.size() > 0) {
                        listener.onItemClickXemFile(itemDauViecArrayList.get(position));
                    }
                }
            }
        });
        viewHolder.btnXuLy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (itemDauViecArrayList.size() > 0) {
                        listener.onItemClickXuLy(itemDauViecArrayList.get(position));
                    }
                }
            }
        });
        viewHolder.btnXemChiTiet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (itemDauViecArrayList.size() > 0) {
                        listener.onItemClickXemChiTiet(itemDauViecArrayList.get(position));
                    }
                }
            }
        });
    ...
    public int getItemCount() {
        return itemDauViecArrayList.size();
    }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViec itemDauViec);

        void onItemClickXuLy(ItemDauViec itemDauViec);

        void onItemClickXemChiTiet(ItemDauViec itemDauViec);
    }
}
