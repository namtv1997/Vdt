...
public class AdapterVanBanPhoiHopChoXuLy extends RecyclerView.Adapter<AdapterVanBanPhoiHopChoXuLy.ViewHolder> {
    private ArrayList<VanBanPhoiHopChoXuLy> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanPhoiHopChoXuLy(ArrayList<VanBanPhoiHopChoXuLy> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanPhoiHopChoXuLy giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanPhoiHopChoXuLy vanBanPhoiHopChoXuLy);

        void onItemClickXuLy(VanBanPhoiHopChoXuLy vanBanPhoiHopChoXuLy);

        void onItemClickXemChiTiet(VanBanPhoiHopChoXuLy vanBanPhoiHopChoXuLy);
    }
}
