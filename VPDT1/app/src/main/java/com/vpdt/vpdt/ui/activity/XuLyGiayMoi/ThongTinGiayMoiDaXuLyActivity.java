...
public class ThongTinGiayMoiDaXuLyActivity extends BaseActivity<TTVBGiayMoiPhongChuTriChoXuLyPresenter> implements TTVBGiayMoiPhongChuTriChoXuLyView,
        ...
        AdapterKetQuaGiaiQuyetPhongPH.OnItemketquaGiaiquyetClickListener {
    ...
    public int getContentViewId() {
        return R.layout.activity_thong_tin_giay_moi_da_xu_ly;
    }
    ...
    public void onGetDaTaSuccess(DetailGiayMoiPhongChuTriChoXuLy detailGiayMoiPhongChuTriChoXuLy) {
        ...
        RecyclerViewKetQuaGiaiQuyetPhongPH((ArrayList<KetQuaGiaiQuyetPhongPP>) detailGiayMoiPhongChuTriChoXuLy.getketQuaGiaiQuyetPhongPHs());
        ...
        if (detailGiayMoiPhongChuTriChoXuLy.getketQuaGiaiQuyetPhongPHs().size() == 0) {
    ...
    @OnClick({R.id.imvBack, R.id.tvThongTinVanBan, R.id.lnTTVB,
            ...
            R.id.tvKetQuaGiaiQuyetPThuLy, R.id.tvTrinhTuHoanThanhCV, R.id.btnSoanBaoCao, R.id.btnCVDaHoanThanh, R.id.tvKetQuaGiaiQuyetPPH})
