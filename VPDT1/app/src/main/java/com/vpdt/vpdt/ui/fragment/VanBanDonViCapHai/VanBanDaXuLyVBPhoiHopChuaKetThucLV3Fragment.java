...
import com.vpdt.vpdt.ui.activity.VanBanDonViCapHai.NDVBVanBanChoXuLyVBPhoiHopLV3Activity;
...
public class VanBanDaXuLyVBPhoiHopChuaKetThucLV3Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV3Presenter> implements VanBanChoXuLyVBChuTriLV3View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_da_xu_ly_vb_phoi_hop_chua_ket_thuc_lv3;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBDaXuLyTPPhoHopDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBDaXuLyTPPhoHopDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBDaXuLyTPPhoHopDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBDaXuLyTPPhoHopDonViCapHai(String.valueOf(integer), true);
    ...
    public void onItemClickXuLy(VanBanChoXuLyLV3 vanBanChoXuLyLV3) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVBVanBanChoXuLyVBPhoiHopLV3Activity.class);
