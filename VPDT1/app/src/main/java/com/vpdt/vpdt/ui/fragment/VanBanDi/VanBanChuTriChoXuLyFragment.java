...
import com.vpdt.vpdt.presenter.impl.VanBanChuTriChoXuLyPresenterImpl;
import com.vpdt.vpdt.ui.activity.MainActivity;
import com.vpdt.vpdt.ui.activity.VanBanDi.NDVBVanBanChuTriChoXuLyActivity;
import com.vpdt.vpdt.ui.activity.VanBanDi.TTVBVanBanTrinhKyActivity;
import com.vpdt.vpdt.ui.adapter.AdapterNamLamViec;
import com.vpdt.vpdt.ui.adapter.AdapterVanBanChuTriChoXuLy;
...
public class VanBanChuTriChoXuLyFragment extends BaseFragment<VanBanChuTriChoXuLyPresenter> implements VanBanChuTriChoXuLyView,
        AdapterVanBanChuTriChoXuLy.OnItemClickListener, AdapterNamLamViec.OnItemClickListenerNamLamViec {
    ...
    AdapterVanBanChuTriChoXuLy listAdapter;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_van_ban_chu_tri_cho_xu_ly;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getVBdi_chuaxuly_tp(NamLamViec, true);

        listAdapter = new AdapterVanBanChuTriChoXuLy(getPresenter().VAN_BAN_DI_CHUA_XU_LY_ARRAY_LIST(), this);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getVBdi_chuaxuly_tp(NamLamViec, false);
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countVBdi_chuaxuly_tp(NamLamViec);

    }

    @Override
    public VanBanChuTriChoXuLyPresenter createPresenter() {
        return new VanBanChuTriChoXuLyPresenterImpl(this);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getVBdi_chuaxuly_tp(String.valueOf(integer), true);
    ...
    @Override
    public void onItemClickXemFile(VanBanDiChuaXuLy vanBanDiChuaXuLy) {
        if (vanBanDiChuaXuLy.getDuongdan().isEmpty() || vanBanDiChuaXuLy.getDuongdan() == null) {
    ...
    @Override
    public void onItemClickXuLy(VanBanDiChuaXuLy vanBanDiChuaXuLy) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVBVanBanChuTriChoXuLyActivity.class);
            intent.putExtra("vanBanDiChuaXuLy", vanBanDiChuaXuLy);
    ...
    @Override
    public void onItemClickXemChiTiet(VanBanDiChuaXuLy vanBanDiChuaXuLy) {
        if (!click) {
            Intent intent = new Intent(getActivity(), TTVBVanBanTrinhKyActivity.class);
            intent.putExtra("ID_VANBAN_DI", vanBanDiChuaXuLy.getMavb());
            startActivity(intent);
            click = true;
        }
