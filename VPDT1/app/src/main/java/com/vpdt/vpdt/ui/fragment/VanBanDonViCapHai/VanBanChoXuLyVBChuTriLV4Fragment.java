...
public class VanBanChoXuLyVBChuTriLV4Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV4Presenter> implements VanBanChoXuLyVBChuTriLV4View,
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBChoXuLyPPChuTriDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBChoXuLyPPChuTriDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBChoXuLyPPChuTriDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBChoXuLyPPChuTriDonViCapHai(String.valueOf(integer), true);
