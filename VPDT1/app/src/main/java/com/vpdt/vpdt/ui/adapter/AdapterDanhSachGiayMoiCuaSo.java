...
public class AdapterDanhSachGiayMoiCuaSo extends RecyclerView.Adapter<AdapterDanhSachGiayMoiCuaSo.ViewHolder> {
    private ArrayList<DetailVanBanDiTongThe> detailVanBanDiTongTheArrayList;
    private Context mContext;
    private OnItemClickListener listener;


    public AdapterDanhSachGiayMoiCuaSo(Context mContext, ArrayList<DetailVanBanDiTongThe> detailVanBanDiTongTheArrayList, OnItemClickListener listener) {
...
//        } else {
//            viewHolder.tvHanXuLy.setText(String.valueOf("Ngày gửi đi: " + giaHanGiaiQuyet.getNgayVBdi()));
//        }
