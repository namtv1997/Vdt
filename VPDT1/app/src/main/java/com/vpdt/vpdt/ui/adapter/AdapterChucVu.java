...
public class AdapterChucVu extends RecyclerView.Adapter<AdapterChucVu.ViewHolder> {
    private ArrayList<KhuVuc> khuVucArrayList;
    private OnItemChucVuClickListener listener;

    public AdapterChucVu(ArrayList<KhuVuc> khuVucArrayList, OnItemChucVuClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onItemChucVuClick(khuVucArrayList.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemChucVuClickListener {
        void onItemChucVuClick(KhuVuc khuVuc);
    }
}
