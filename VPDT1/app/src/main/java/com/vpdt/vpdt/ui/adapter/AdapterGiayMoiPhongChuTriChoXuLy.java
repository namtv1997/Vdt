...
public class AdapterGiayMoiPhongChuTriChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiPhongChuTriChoXuLy.ViewHolder> {
    private ArrayList<GMPhongChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiPhongChuTriChoXuLy(ArrayList<GMPhongChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GMPhongChuTriChoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GMPhongChuTriChoXuLy gmPhongChuTriChoXuLy);

        void onItemClickXuLy(GMPhongChuTriChoXuLy gmPhongChuTriChoXuLy);

        void onItemClickXemChiTiet(GMPhongChuTriChoXuLy gmPhongChuTriChoXuLy);
    }
}
