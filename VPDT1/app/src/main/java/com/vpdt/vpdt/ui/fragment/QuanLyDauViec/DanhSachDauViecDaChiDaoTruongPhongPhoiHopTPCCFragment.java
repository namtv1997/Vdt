...
import com.vpdt.vpdt.ui.adapter.AdapterDanhSachDauViecDaChiDaoTruongPhongPhoihop;
...
public class DanhSachDauViecDaChiDaoTruongPhongPhoiHopTPCCFragment extends BaseFragment<DauViecPhongChuTriDaChiDaoChuaHTPresenter> implements DauViecPhongChuTriDaChiDaoChuaHTView,
        AdapterDanhSachDauViecDaChiDaoTruongPhongPhoihop.OnItemXemFileClickListener,
    ...
    AdapterDanhSachDauViecDaChiDaoTruongPhongPhoihop adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_dau_viec_da_chi_dao_truong_phong_phoi_hop_tpcc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecDaChiDaoTruongPhongPhoHopCT(NamLamViec);
    ...
    public void ongetAllDauViecPhongChuTriDaChiDaoSuccess(ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList) {
        adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT = new AdapterDanhSachDauViecDaChiDaoTruongPhongPhoihop(getActivity(), danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList, this);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecDaChiDaoTruongPhongPhoHopCT(String.valueOf(integer));
