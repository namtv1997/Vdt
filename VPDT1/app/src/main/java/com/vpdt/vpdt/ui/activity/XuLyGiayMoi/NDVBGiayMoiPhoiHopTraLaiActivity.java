...
import com.vpdt.vpdt.presenter.NDVBGiayMoiPhoiHopTraLaiPresenter;
import com.vpdt.vpdt.presenter.NDVBGiayMoiPhoiHopTraLaiView;
import com.vpdt.vpdt.presenter.impl.NDVBGiayMoiPhoiHopTraLaiPresenterImpl;
...
public class NDVBGiayMoiPhoiHopTraLaiActivity extends BaseActivity<NDVBGiayMoiPhoiHopTraLaiPresenter> implements NDVBGiayMoiPhoiHopTraLaiView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbgiay_moi_phoi_hop_tra_lai;
    }
    ...
    public void initializeComponents() {
        ...
        if (vanBanPhoiHopTraLai != null) {
            ...
            tvNoigui.setText(String.valueOf(vanBanPhoiHopTraLai.getNoiGui()));
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBGiayMoiPhoiHopTraLaiActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                getPresenter().duyetGMPhoiHopTraLai(idvb, idPhoPhong, idPhoPhongPhoiHop, idChuyenVienPhoiHops,
                        tvChiDao1.getText().toString(), tvChiDao2.getText().toString(), tvNgayThangNam.getText().toString(), idCanBoTuChoi);
                break;
    ...
    @Override
    public NDVBGiayMoiPhoiHopTraLaiPresenter createPresenter() {
        return new NDVBGiayMoiPhoiHopTraLaiPresenterImpl(this);
    }
