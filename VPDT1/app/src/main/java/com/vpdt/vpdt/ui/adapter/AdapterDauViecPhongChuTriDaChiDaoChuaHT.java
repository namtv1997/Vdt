...
public class AdapterDauViecPhongChuTriDaChiDaoChuaHT extends RecyclerView.Adapter<AdapterDauViecPhongChuTriDaChiDaoChuaHT.ViewHolder> {
    private ArrayList<ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecPhongChuTriDaChiDaoChuaHT(ArrayList<ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
        ...
        viewHolder.tvTieuDeNoiDung.setText("Chỉ đạo của đ/c " + giaHanGiaiQuyet.getCanBoChiDao() + ":");
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh itemDauViecPhongChuTriDaChiDaoChuaHoanThanh);

        void onItemClickXuLy(ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh itemDauViecPhongChuTriDaChiDaoChuaHoanThanh);

        void onItemClickXemChiTiet(ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh itemDauViecPhongChuTriDaChiDaoChuaHoanThanh);
    }
}
