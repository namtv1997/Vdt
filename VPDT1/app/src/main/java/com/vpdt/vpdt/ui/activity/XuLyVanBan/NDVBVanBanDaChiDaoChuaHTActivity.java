...
public class NDVBVanBanDaChiDaoChuaHTActivity extends BaseActivity<NDVB_VanBanDaChiDaoChuaHTPresenter> implements NDVB_VanBanDaChiDaoChuaHTView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_da_chi_dao_chua_ht;
    }
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanDaChiDaoChuaHTActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                ...
                getPresenter().duyetVBDaChiDaoChuaHoanThanhCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), idvb, idChiCuc, idChiCucPho, idTruongPhong, idTruongPhongPP,
