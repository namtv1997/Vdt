...
public class ItemPhongChuTriChuyenVienChoXuLy  implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("moTa")
    ...
    protected ItemPhongChuTriChuyenVienChoXuLy(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
        ...
        trinhTuChuyenNhan = in.createStringArrayList();
    }

    public static final Creator<ItemPhongChuTriChuyenVienChoXuLy> CREATOR = new Creator<ItemPhongChuTriChuyenVienChoXuLy>() {
        @Override
        public ItemPhongChuTriChuyenVienChoXuLy createFromParcel(Parcel in) {
            return new ItemPhongChuTriChuyenVienChoXuLy(in);
        }

        @Override
        public ItemPhongChuTriChuyenVienChoXuLy[] newArray(int size) {
            return new ItemPhongChuTriChuyenVienChoXuLy[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeStringList(trinhTuChuyenNhan);
    }
}
