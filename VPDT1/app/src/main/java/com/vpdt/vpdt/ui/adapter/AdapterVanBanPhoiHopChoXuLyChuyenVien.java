...
public class AdapterVanBanPhoiHopChoXuLyChuyenVien extends RecyclerView.Adapter<AdapterVanBanPhoiHopChoXuLyChuyenVien.ViewHolder> {
    private ArrayList<VanBanPhoiHopChoXuLyChuyenVien> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanPhoiHopChoXuLyChuyenVien(ArrayList<VanBanPhoiHopChoXuLyChuyenVien> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanPhoiHopChoXuLyChuyenVien giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanPhoiHopChoXuLyChuyenVien vanBanPhoiHopChoXuLy);

        void onItemClickXuLy(VanBanPhoiHopChoXuLyChuyenVien vanBanPhoiHopChoXuLy);

        void onItemClickXemChiTiet(VanBanPhoiHopChoXuLyChuyenVien vanBanPhoiHopChoXuLy);
    }
}
