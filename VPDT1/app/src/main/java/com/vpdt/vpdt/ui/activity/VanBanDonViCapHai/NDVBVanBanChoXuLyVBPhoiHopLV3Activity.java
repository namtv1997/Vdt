...
public class NDVBVanBanChoXuLyVBPhoiHopLV3Activity extends BaseActivity<NDVBVanBanChoXuLyLV3Presenter> implements NDVBVanBanChoXuLyLV3View,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_cho_xu_ly_vbphoi_hop_lv3;
    }
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanChoXuLyVBPhoiHopLV3Activity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBChoXuLyTPPhoiHopDonViCapHai(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
