...
public class AdapterKhuVuc extends RecyclerView.Adapter<AdapterKhuVuc.ViewHolder> {
    private ArrayList<KhuVuc> khuVucArrayList;
    private OnItemKhuVucClickListener listener;

    public AdapterKhuVuc(ArrayList<KhuVuc> khuVucArrayList, OnItemKhuVucClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onItemKhuVucClick(khuVucArrayList.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemKhuVucClickListener {
        void onItemKhuVucClick(KhuVuc khuVuc);
    }
}
