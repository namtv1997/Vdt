...
public class AdapterDanhSachDauViecPhongChuTri1 extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongChuTri1.ViewHolder> {
    private ArrayList<ItemDauViec> itemDauViecArrayList;
    private Context mContext;
    private OnItemClickListener listener;


    public AdapterDanhSachDauViecPhongChuTri1(Context mContext, ArrayList<ItemDauViec> itemDauViecArrayList, OnItemClickListener listener) {
