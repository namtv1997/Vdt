...
public interface NoiDungGiayMoiChoPhanLoaiView extends BaseView<NoiDungGiayMoiChoPhanLoaiPresenter> {
    Context gContext();
    ...
    void duyetGMChuaPhanLoaiSuccess();

    void themNoidungGMChuaPhanLoaiSuccess();
}
