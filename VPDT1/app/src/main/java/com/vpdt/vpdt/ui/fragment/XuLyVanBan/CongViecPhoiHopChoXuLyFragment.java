...
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NDVBCongViecPhoiHopChoXuLyActivity;
...
public class CongViecPhoiHopChoXuLyFragment extends BaseFragment<DeXuatCongViecPhoiHopChoDuyetPresenter> implements DeXuatCongViecPhoiHopChoDuyetView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_cong_viec_phoi_hop_cho_xu_ly;
    }
    ...
    public void onItemClickXuLy(DeXuatCongViecPhoiHopChoDuyet deXuatCongViecPhoiHopChoDuyet) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVBCongViecPhoiHopChoXuLyActivity.class);
