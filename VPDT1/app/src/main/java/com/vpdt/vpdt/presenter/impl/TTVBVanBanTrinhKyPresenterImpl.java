...
public class TTVBVanBanTrinhKyPresenterImpl extends BasePresenterImpl<TTVBVanBanTrinhKyView> implements TTVBVanBanTrinhKyPresenter {
    public TTVBVanBanTrinhKyPresenterImpl(TTVBVanBanTrinhKyView view) {
        super(view);
    }
