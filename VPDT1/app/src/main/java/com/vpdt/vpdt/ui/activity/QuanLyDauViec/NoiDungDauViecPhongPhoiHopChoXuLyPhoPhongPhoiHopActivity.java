...
import com.vpdt.vpdt.presenter.NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopPresenter;
import com.vpdt.vpdt.presenter.NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopView;
import com.vpdt.vpdt.presenter.impl.NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopPresenterImpl;
...
public class NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopActivity extends BaseActivity<NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopPresenter> implements NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopView,
    ...
    public int getContentViewId() {
        return R.layout.activity_noi_dung_dau_viec_phong_phoi_hop_cho_xu_ly_pho_phong_phoi_hop;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnNoiDungVB:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongPhoHopChoXuLyTPPP(id, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                break;
    ...
    @Override
    public NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopPresenter createPresenter() {
        return new NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopPresenterImpl(this);
    }
