...
import com.vpdt.vpdt.ui.adapter.AdapterDanhSachDauViecPhongPhoiHop;
...
public class DanhSachDauViecPhongPhoiHopFragment extends BaseFragment<DanhSachDauViecPhongPhoiHopPresenter> implements DanhSachDauViecPhongPhoiHopView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDanhSachDauViecPhongPhoiHop.OnItemXemFileClickListener {
    ...
    AdapterDanhSachDauViecPhongPhoiHop adapterDanhSachDauViecPhongPhoiHop;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_dau_viec_phong_phoi_hop;
    }
    ...
    public void onStart() {
        ...
        adapterDanhSachDauViecPhongPhoiHop = new AdapterDanhSachDauViecPhongPhoiHop(getActivity(), getPresenter().DANH_SACH_DAU_VIEC_PHONG_PHOI_HOP_ARRAY_LIST(), this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerview.setLayoutManager(layoutManager);
        recyclerview.setAdapter(adapterDanhSachDauViecPhongPhoiHop);
    ...
    public void onGetDataPhongPhoiHopSuccess() {
        adapterDanhSachDauViecPhongPhoiHop.notifyDataSetChanged();
