...
public class NDVB_GMGiaoPhongPhoiHopDaChiDaoPresenterImpl extends BasePresenterImpl<NDVB_GMGiaoPhongPhoiHopDaChiDaoView> implements NDVB_GMGiaoPhongPhoiHopDaChiDaoPresenter {
    public NDVB_GMGiaoPhongPhoiHopDaChiDaoPresenterImpl(NDVB_GMGiaoPhongPhoiHopDaChiDaoView view) {
        super(view);
    }
    ...
    @Override
    public void duyetAllGMGiaoPhongPhoiHopDaChiDao(int id, int idPhoPhong, String idPhoPhongPhoiHops,
                                                   String idChuyenVienPhoiHops, String chiDao,
                                                   String chiDaoChuTri, String hanGiaiQuyet) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetGMGiaoPhongPhoiHopDaChiDao(token, id, idPhoPhong, idPhoPhongPhoiHops, idChuyenVienPhoiHops, chiDao, chiDaoChuTri, hanGiaiQuyet,
