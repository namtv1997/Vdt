...
public class AdapterSoLuongVanBanGiaoPhongChuTri extends RecyclerView.Adapter<AdapterSoLuongVanBanGiaoPhongChuTri.ViewHolder> {
    private ArrayList<SoLuongVanBanGiaoPhongChuTri> ToCongTacList;
    private OnItemClickListener listener;


    public AdapterSoLuongVanBanGiaoPhongChuTri(ArrayList<SoLuongVanBanGiaoPhongChuTri> ToCongTacList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        SoLuongVanBanGiaoPhongChuTri giaHanGiaiQuyet = ToCongTacList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(SoLuongVanBanGiaoPhongChuTri soLuongVanBanGiaoPhongChuTri);

        void onItemClickXuLy(SoLuongVanBanGiaoPhongChuTri soLuongVanBanGiaoPhongChuTri);

        void onItemClickXemChiTiet(SoLuongVanBanGiaoPhongChuTri soLuongVanBanGiaoPhongChuTri);
    }
}
