...
public class TTVBThongTinDaXemActivity extends BaseActivity<TTVBThongTinMoiPresenter> implements TTVBThongTinMoiView, AdapterCacFileDinhKem.OnItemClickListenerFileDinhKem {
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbthong_tin_da_xem;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("TTVBThongTinDaXem")) {
                idvb = intent.getIntExtra("TTVBThongTinDaXem", 0);
