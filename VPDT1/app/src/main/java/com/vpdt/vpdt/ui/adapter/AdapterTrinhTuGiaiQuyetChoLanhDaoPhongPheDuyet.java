...
public class AdapterTrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet extends RecyclerView.Adapter<AdapterTrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet.ViewHolder> {
    private ArrayList<TrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet> trinhTuGiaiQuyets;

    public AdapterTrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet(ArrayList<TrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet> trinhTuGiaiQuyets) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        TrinhTuGiaiQuyetChoLanhDaoPhongPheDuyet trinhTuGiaiQuyet = trinhTuGiaiQuyets.get(position);
