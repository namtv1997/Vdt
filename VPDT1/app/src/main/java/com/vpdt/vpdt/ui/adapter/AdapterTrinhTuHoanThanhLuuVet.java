...
public class AdapterTrinhTuHoanThanhLuuVet extends RecyclerView.Adapter<AdapterTrinhTuHoanThanhLuuVet.ViewHolder> {
    private ArrayList<TrinhTuHoanThanhLuuVet> trinhTuHoanThanhLuuVets;
    private Context mContext;

    public AdapterTrinhTuHoanThanhLuuVet(Context mContext, ArrayList<TrinhTuHoanThanhLuuVet> trinhTuHoanThanhLuuVets) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        TrinhTuHoanThanhLuuVet trinhTuHoanThanhLuuVet = trinhTuHoanThanhLuuVets.get(position);
