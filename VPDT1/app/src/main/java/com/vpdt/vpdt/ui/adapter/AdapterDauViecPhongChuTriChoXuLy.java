...
public class AdapterDauViecPhongChuTriChoXuLy extends RecyclerView.Adapter<AdapterDauViecPhongChuTriChoXuLy.ViewHolder> {
    private ArrayList<ItemDauViecPhongChuTriChoXuLy> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecPhongChuTriChoXuLy(ArrayList<ItemDauViecPhongChuTriChoXuLy> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViecPhongChuTriChoXuLy giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong);

        void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong);

        void onItemClickXemChiTiet(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong);
    }
}
