...
public class TTVBVanBanPhoiHopDaChiDaoActivity extends BaseActivity<TTVBVanBanPhoiHopTraLaiPresenter> implements TTVBVanBanPhoiHopTraLaiView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbvan_ban_phoi_hop_da_chi_dao;
    }
