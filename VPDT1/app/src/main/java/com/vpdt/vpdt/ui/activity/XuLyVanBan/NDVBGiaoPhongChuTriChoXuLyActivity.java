...
public class NDVBGiaoPhongChuTriChoXuLyActivity extends BaseActivity<NoiDungVanBanGiaoPhongChoXuLyPresenter> implements
    ...
    public void initializeComponents() {
        ...
        if (phongChuTri != null) {
            ...
            tvTenChiDao.setText(String.valueOf("*Nội dung chỉ đạo của đ/c " + phongChuTri.getTenChiDao() + ":"));
            tvNDChiDao.setText(String.valueOf(phongChuTri.getNoiDungChiDao()));
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBGiaoPhongChuTriChoXuLyActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        switch (view.getId()) {
            ...
            case R.id.btnTuChoi:
                ...
                btnChuyenChanhVanBan.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (tuChoiTP) {
                            getPresenter().tuChoiTPVBPhongChuTriChoXuLy(PrefUtil.getString(NDVBGiaoPhongChuTriChoXuLyActivity.this, Key.NAM_LAM_VIEC, ""),
