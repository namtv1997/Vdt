...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecPhongPhoiHopChoXuLyTPCCActivity;
...
public class AdapterDauViecPhongPhoiHopChoXuLyTPCC extends RecyclerView.Adapter<AdapterDauViecPhongPhoiHopChoXuLyTPCC.ViewHolder> implements AdapterDauViecPhongChuTriChoXuLyTPCC1.OnItemClickListener {
    ...
    public AdapterDauViecPhongPhoiHopChoXuLyTPCC(Context context, ArrayList<DauViecPhongChuTriChoXuLyTPCC> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC) {
        Intent intent = new Intent(context, NDVBDauViecPhongPhoiHopChoXuLyTPCCActivity.class);
    ...
    public void onItemClickXemChiTiet(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC) {
        ...
        intent.putExtra("idvb", itemDauViecPhongChuTriChoXuLyTCC.getId());
        context.startActivity(intent);
    }
