...
public class NDVBDSDauViecPhongPhoiHopDaXuLyCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyCCView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdsdau_viec_phong_phoi_hop_da_xu_ly_cc;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnChonPhoiHop:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongPhoHopDaXuLyCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), id, idPhongPhoiHop, tenPhongPhoiHop, tvNgayThangNam.getText().toString());
                break;
