...
public class AdapterGiayMoiChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiChoXuLy.ViewHolder> {
    private ArrayList<GiayMoiChoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiChoXuLy(ArrayList<GiayMoiChoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiChoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiChoXuLy giayMoiChoXuLy);

        void onItemClickXuLy(GiayMoiChoXuLy giayMoiChoXuLy);

        void onItemClickXemChiTiet(GiayMoiChoXuLy giayMoiChoXuLy);
    }
}
