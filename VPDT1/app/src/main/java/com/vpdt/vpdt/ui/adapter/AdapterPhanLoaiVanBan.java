...
public class AdapterPhanLoaiVanBan extends RecyclerView.Adapter<AdapterPhanLoaiVanBan.ViewHolder> {
    private ArrayList<PhanLoaiVanBan> dsvb_quaHanArrayList;
    private OnItemClickListener listener;


    public AdapterPhanLoaiVanBan(ArrayList<PhanLoaiVanBan> dsvb_quaHanArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        PhanLoaiVanBan giaHanGiaiQuyet = dsvb_quaHanArrayList.get(position);
...
//        if (giaHanGiaiQuyet.getNguoiNhap().isEmpty() || giaHanGiaiQuyet.getng() == null) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(PhanLoaiVanBan phanLoaiVanBan);

        void onItemClickXuLy(PhanLoaiVanBan phanLoaiVanBan);

        void onItemClickXemChiTiet(PhanLoaiVanBan phanLoaiVanBan);
    }
}
