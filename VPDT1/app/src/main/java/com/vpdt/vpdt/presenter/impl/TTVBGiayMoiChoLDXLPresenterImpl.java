...
public class TTVBGiayMoiChoLDXLPresenterImpl extends BasePresenterImpl<TTVBGiayMoiChoLDXLView> implements TTVBGiayMoiChoLDXLPresenter {

    public TTVBGiayMoiChoLDXLPresenterImpl(TTVBGiayMoiChoLDXLView view) {
        super(view);
    }
