...
public class NDVBGiayMoiPhongPhoiHopChoXuLyPresenterImpl extends BasePresenterImpl<NDVBGiayMoiPhongPhoiHopChoXuLyView> implements NDVBGiayMoiPhongPhoiHopChoXuLyPresenter {
    public NDVBGiayMoiPhongPhoiHopChoXuLyPresenterImpl(NDVBGiayMoiPhongPhoiHopChoXuLyView view) {
        super(view);
    }
    ...
    public void duyetGMPhongPhoiHopChoXuLy(int id, int idPhoPhong, String idPhoPhongPhoiHops, String idChuyenVienPhoiHops, String chiDao, String chiDaoChuTri, String hanGiaiQuyet) {
        ...
        NetworkModule.getService().duyetGMPhongPhoiHopChoXuLy(token, id, idPhoPhong, idPhoPhongPhoiHops, idChuyenVienPhoiHops, chiDao, chiDaoChuTri, hanGiaiQuyet,
