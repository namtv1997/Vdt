...
public class AdapterDanhsachDauViecPhongPhoiHopDaXuLy extends RecyclerView.Adapter<AdapterDanhsachDauViecPhongPhoiHopDaXuLy.ViewHolder> implements AdapterDauViecPhongChuTriDaChiDaoChuaHT.OnItemClickListener {
    ...
    public AdapterDanhsachDauViecPhongPhoiHopDaXuLy(Context context, ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
