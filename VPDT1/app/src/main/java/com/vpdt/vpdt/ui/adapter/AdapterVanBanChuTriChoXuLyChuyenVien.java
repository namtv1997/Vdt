...
public class AdapterVanBanChuTriChoXuLyChuyenVien extends RecyclerView.Adapter<AdapterVanBanChuTriChoXuLyChuyenVien.ViewHolder> {
    private ArrayList<VanBanChuTriChoXuLyChuyenVien> DSVB_DaChiDaoList;

    private OnItemClickListener listener;


    public AdapterVanBanChuTriChoXuLyChuyenVien(ArrayList<VanBanChuTriChoXuLyChuyenVien> DSVB_DaChiDaoList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChuTriChoXuLyChuyenVien dsvb_daChiDao = DSVB_DaChiDaoList.get(position);
...
//        } else {
//            viewHolder.tvLoaiVanBan.setText(String.valueOf("Loại văn bản: " + dsvb_daChiDao.getlo()));
//        }
...
//
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChuTriChoXuLyChuyenVien vanBanChuTriChoXuLyChuyenVien);

        void onItemClickXuLy(VanBanChuTriChoXuLyChuyenVien vanBanChuTriChoXuLyChuyenVien);

        void onItemClickXemChiTiet(VanBanChuTriChoXuLyChuyenVien vanBanChuTriChoXuLyChuyenVien);
    }
}
