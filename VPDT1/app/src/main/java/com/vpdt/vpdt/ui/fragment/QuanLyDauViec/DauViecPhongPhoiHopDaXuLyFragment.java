...
import com.vpdt.vpdt.ui.adapter.AdapterDanhsachDauViecPhongPhoiHopDaXuLy;
...
public class DauViecPhongPhoiHopDaXuLyFragment extends BaseFragment<DauViecPhongPhoiHopDaChiDaoChuaHTPresenter> implements DauViecPhongPhoiHopDaChiDaoChuaHTView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDanhsachDauViecPhongPhoiHopDaXuLy.OnItemXemFileClickListener {
    ...
    AdapterDanhsachDauViecPhongPhoiHopDaXuLy adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_dau_viec_phong_phoi_hop_da_xu_ly;
    }
    ...
    public void ongetAllDauViecPhongPhoHopDaChiDaoSuccess(ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList) {
        adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT = new AdapterDanhsachDauViecPhongPhoiHopDaXuLy(getActivity(), danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList, this);
