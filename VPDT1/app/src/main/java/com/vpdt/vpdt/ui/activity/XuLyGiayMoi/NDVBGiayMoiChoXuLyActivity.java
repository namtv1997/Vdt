...
public class NDVBGiayMoiChoXuLyActivity extends BaseActivity<NDVB_GiayMoiChoXuLyPresenter> implements NDVB_GiayMoiChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbgiay_moi_cho_xu_ly;
    }
    ...
    public void initializeComponents() {
        ...
        GiayMoiChoXuLy phongChuTriChoXuLyCC = getIntent().getParcelableExtra("giayMoiChoXuLy");
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBGiayMoiChoXuLyActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                ...
                getPresenter().duyetVBPhongChoXuLyCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), idvb, idChiCuc, idChiCucPho, idTruongPhong, idTruongPhongPP,
