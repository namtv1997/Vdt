...
public class AdapterKetQuaGiaiQuyetPhongThuLyDonThu extends RecyclerView.Adapter<AdapterKetQuaGiaiQuyetPhongThuLyDonThu.ViewHolder> {
    ...
    public AdapterKetQuaGiaiQuyetPhongThuLyDonThu(ArrayList<KetGiaiQuyetPhongThuLy> ketquaGiaiquyetPhongThulyArrayList, OnItemketquaGiaiquyetPhongThulyClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.tvCanBoDonVi.setText(ketquaGiaiquyetPhongPhoihop.getCanBoDonvi());
    ...
    public interface OnItemketquaGiaiquyetPhongThulyClickListener {
        ...
        void onItemTacVuClick(KetGiaiQuyetPhongThuLy ketquaGiaiquyetPhongThuly);
    }
}
