...
public class ThongKeVanBanTheoPhoGiamDocFragment extends BaseFragment<DSVB_TheoPhongPresenter> implements DSVB_TheoPhongView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_thongkevanbantheophogiamdoc;
    }
    ...
    @OnClick({R.id.btnNamLamViecDSVBTheoPhong, R.id.btnBackDSVBTheoPhong, R.id.tvNgayNhap, R.id.tvDenNgay, R.id.btnSearch,
            R.id.vDSVBTheoPhong, R.id.lntp, R.id.rltp})
