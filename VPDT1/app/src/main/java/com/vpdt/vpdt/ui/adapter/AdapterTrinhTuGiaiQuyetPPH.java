...
public class AdapterTrinhTuGiaiQuyetPPH extends RecyclerView.Adapter<AdapterTrinhTuGiaiQuyetPPH.ViewHolder> {
    private ArrayList<TrinhTuGiaiQuyetPPH> trinhTuGiaiQuyets;

    public AdapterTrinhTuGiaiQuyetPPH(ArrayList<TrinhTuGiaiQuyetPPH> trinhTuGiaiQuyets) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        TrinhTuGiaiQuyetPPH trinhTuGiaiQuyet = trinhTuGiaiQuyets.get(position);
