...
import com.vpdt.vpdt.presenter.NoiDungGiayMoiDaPhanLoaiPresenter;
import com.vpdt.vpdt.presenter.NoiDungGiayMoiDaPhanLoaiView;
import com.vpdt.vpdt.presenter.impl.NoiDungGiayMoiDaPhanLoaiPresenterImpl;
...
public class NoiDungGiayMoiDaPhanLoaiActivity extends BaseActivity<NoiDungGiayMoiDaPhanLoaiPresenter> implements NoiDungGiayMoiDaPhanLoaiView,
    ...
    public int getContentViewId() {
        return R.layout.activity_noi_dung_giay_moi_da_phan_loai;
    }
    ...
    public void initializeComponents() {
        ...
        GiayMoiDaPhanLoai giayMoiDaPhanLoai = getIntent().getParcelableExtra("giayMoiDaPhanLoai");
        if (giayMoiDaPhanLoai != null) {
            if (!giayMoiDaPhanLoai.getGiayMoiGio().isEmpty() && !giayMoiDaPhanLoai.getGiayMoiNgay().isEmpty() && !giayMoiDaPhanLoai.getGiayMoiDiaDiem().isEmpty()) {
                tvNgayGio.setText("( Vào hồi " + giayMoiDaPhanLoai.getGiayMoiGio() + " ngày " + giayMoiDaPhanLoai.getGiayMoiNgay() + ", tại" + giayMoiDaPhanLoai.getGiayMoiDiaDiem() + ")");
            }
            id = giayMoiDaPhanLoai.getId();
            idGiamDoc = giayMoiDaPhanLoai.getIdGiamDoc();
            idPhoGiamDoc = giayMoiDaPhanLoai.getIdPhoGiamDoc();
            idPhongChuTri = giayMoiDaPhanLoai.getIdPhongChuTri();
            fileDinhKem = giayMoiDaPhanLoai.getUrlFile();
            id_phongphoihop = giayMoiDaPhanLoai.getIdPhongPhoiHop();
            tvNgay.setText(String.valueOf(giayMoiDaPhanLoai.getNgayNhap()));
            tvChuyenGiamDoc.setText(String.valueOf(giayMoiDaPhanLoai.getTenGiamDoc()));
            tvChuyenPGiamDoc.setText(String.valueOf(giayMoiDaPhanLoai.getTenPhoGiamDoc()));
            tvChonChuTri.setText(String.valueOf(giayMoiDaPhanLoai.getTenPhongChuTri()));
            edtChiDao1.setText(String.valueOf(giayMoiDaPhanLoai.getChiDaoGiamDoc()));
            edtChiDao2.setText(String.valueOf(giayMoiDaPhanLoai.getChiDaoPhoGiamDoc()));
            edtChiDao3.setText(String.valueOf(giayMoiDaPhanLoai.getChiChuTri()));
            tvSKH.setText(String.valueOf(giayMoiDaPhanLoai.getSoKyHieu()));
            tvSoDen.setText(String.valueOf(giayMoiDaPhanLoai.getSoDen()));
            tvNoigui.setText(String.valueOf(giayMoiDaPhanLoai.getNoiGui()));
            tvNgayThangNam.setText(String.valueOf(giayMoiDaPhanLoai.getHanGiaiQuyet()));
            tvTrichYeu.setText(giayMoiDaPhanLoai.getMoTa() + "." + giayMoiDaPhanLoai.getNoiDung());
            hangiaiquyet = giayMoiDaPhanLoai.getHanGiaiQuyet();
        }
    }
    ...
    @OnClick({R.id.tvChuyenGiamDoc, R.id.tvChuyenPGiamDoc, R.id.tvChonChuTri,
            ...
            R.id.btnBack, R.id.btnDuyet, R.id.tvFileDinhKem, R.id.tvXemChiTiet})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvNgayThangNam:
                ...
                datePickerDialog = new DatePickerDialog(NoiDungGiayMoiDaPhanLoaiActivity.this,
            ...
            case R.id.btnDuyet:
                ...
                if (cbGiamDocDuHop.isChecked() && cbPhongDuHop.isChecked()) {
                    getPresenter().duyetGMDaPhanLoai(id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hangiaiquyet, id_phongphoihop, edtChiDao1.getText().toString(), edtChiDao2.getText().toString(), edtChiDao3.getText().toString(), 1, 1);
                } else if (cbGiamDocDuHop.isChecked()) {
                    getPresenter().duyetGMDaPhanLoai(id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hangiaiquyet, id_phongphoihop, edtChiDao1.getText().toString(), edtChiDao2.getText().toString(), edtChiDao3.getText().toString(), 1, 0);
                } else if (cbPhongDuHop.isChecked()) {
                    getPresenter().duyetGMDaPhanLoai(id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hangiaiquyet, id_phongphoihop, edtChiDao1.getText().toString(), edtChiDao2.getText().toString(), edtChiDao3.getText().toString(), 0, 1);
                } else {
                    getPresenter().duyetGMDaPhanLoai(id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hangiaiquyet, id_phongphoihop, edtChiDao1.getText().toString(), edtChiDao2.getText().toString(), edtChiDao3.getText().toString(), 0, 0);
                }
                break;
        }
    }
    ...
    @Override
    public void duyetGMDaPhanLoaiSuccess() {
    ...
    @Override
    public NoiDungGiayMoiDaPhanLoaiPresenter createPresenter() {
        return new NoiDungGiayMoiDaPhanLoaiPresenterImpl(this);
    }
}
