...
public class SuaVanBanChoSoCuaSoActivity extends BaseActivity<NhapVanBanDiPresenter> implements NhapVanBanDiView,
    ...
    int idvb, id_lvb, sovb, id_noiduthao, id_lanhdao,
    ...
    public int getContentViewId() {
        return R.layout.activity_nhap_van_ban_di;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("idvb")) {
                ...
                getPresenter().nhapVB_suaVB(idvb);
    ...
    public void NhapVanBanDiSuccess(DSVB_ChoSoCuaSo dsvb_choSoCuaSo) {
        ...
        tvNguoiNhapVanBan.setText(String.valueOf(dsvb_choSoCuaSo.getNguoinhapvb()));
        ...
        switch (view.getId()) {
            ...
            case R.id.tvLanhDaoPhong:
                ...
                btnChuyenPGiamDoc.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        tvLanhDaoPhong.setText("--Chọn lãnh đạo --");
                        dialog.dismiss();
                    }
                });
                break;
            case R.id.tvNoiDuThao:
                AlertDialog.Builder builderNoiDuThao = new AlertDialog.Builder(this);
                LayoutInflater inflaterNoiDuThao = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                LinearLayoutManager layoutManagerNoiDuThao = new LinearLayoutManager(getApplicationContext());
            ...
            case R.id.tvNguoiKy:
                ...
                btnNguoiKy.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        tvNguoiKy.setText("--Chọn Người ký --");
                        dialog.dismiss();
                    }
                });
                break;
            ...
            case R.id.btnCapNhat:
                ...
                if (rdCoDuThaoVbUyBan.isChecked()) {
                    getPresenter().them_capnhapVB(idvb, sovb, ngay_thang, linhvuc, sotrang, soden, trichyeu, ykien, String.valueOf(id_loaivanban),
