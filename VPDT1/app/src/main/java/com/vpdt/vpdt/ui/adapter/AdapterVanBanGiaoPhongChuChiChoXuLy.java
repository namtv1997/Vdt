...
public class AdapterVanBanGiaoPhongChuChiChoXuLy extends RecyclerView.Adapter<AdapterVanBanGiaoPhongChuChiChoXuLy.ViewHolder> {

    private ArrayList<PhongChuTriChoXL> DSVB_DaChiDaoList;
    private Context mContext;
    private OnItemClickListener listener;


    public AdapterVanBanGiaoPhongChuChiChoXuLy(Context mContext, ArrayList<PhongChuTriChoXL> DSVB_DaChiDaoList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        PhongChuTriChoXL dsvb_daChiDao = DSVB_DaChiDaoList.get(position);
...
//        }
        ...
        viewHolder.tvNguoiNhap.setText(String.valueOf("*Nội dung chỉ đạo của đ/c " + dsvb_daChiDao.getTenChiDao() + ":\n" + dsvb_daChiDao.getNoiDungChiDao()));
        if (dsvb_daChiDao.getTenChiDao()==null){
            viewHolder.tvNguoiNhap.setVisibility(View.GONE);
        }else {
            if (dsvb_daChiDao.getTenChiDao().isEmpty()) {
                viewHolder.tvNguoiNhap.setVisibility(View.GONE);
            } else {
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(PhongChuTriChoXL phongChuTri);

        void onItemClickXuLy(PhongChuTriChoXL phongChuTri);

        void onItemClickXemChiTiet(PhongChuTriChoXL phongChuTri);
    }
}
