...
public class GMGiaoPhoiHopChoXuLy implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    protected GMGiaoPhoiHopChoXuLy(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
    ...
    public static final Creator<GMGiaoPhoiHopChoXuLy> CREATOR = new Creator<GMGiaoPhoiHopChoXuLy>() {
        @Override
        public GMGiaoPhoiHopChoXuLy createFromParcel(Parcel in) {
            return new GMGiaoPhoiHopChoXuLy(in);
        }

        @Override
        public GMGiaoPhoiHopChoXuLy[] newArray(int size) {
            return new GMGiaoPhoiHopChoXuLy[size];
        }
    };
