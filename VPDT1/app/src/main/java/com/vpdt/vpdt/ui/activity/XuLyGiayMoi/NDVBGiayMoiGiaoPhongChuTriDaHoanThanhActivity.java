...
import com.vpdt.vpdt.presenter.NDVBGiayMoiGiaoPhongChuTriDaHoanThanhPresenter;
import com.vpdt.vpdt.presenter.NDVBGiayMoiGiaoPhongChuTriDaHoanThanhView;
import com.vpdt.vpdt.presenter.impl.NDVBGiayMoiGiaoPhongChuTriDaHoanThanhPresenterImpl;
...
public class NDVBGiayMoiGiaoPhongChuTriDaHoanThanhActivity extends BaseActivity<NDVBGiayMoiGiaoPhongChuTriDaHoanThanhPresenter> implements NDVBGiayMoiGiaoPhongChuTriDaHoanThanhView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbgiay_moi_giao_phong_chu_tri_da_hoan_thanh;
    }
    ...
    public void initializeComponents() {
        ...
        GMPhongChuTriDaHoanThanh gmPhongChuTriDaHoanThanh = getIntent().getParcelableExtra("gmPhongChuTriDaHoanThanh");
        if (gmPhongChuTriDaHoanThanh != null) {
            idvb = gmPhongChuTriDaHoanThanh.getId();
            idChuyenVien = gmPhongChuTriDaHoanThanh.getIdChuyenVien();
            idPhoPhong = gmPhongChuTriDaHoanThanh.getIdPhoPhong();
            idPhoPhongPhoiHop = gmPhongChuTriDaHoanThanh.getIdPhoPhongPhoiHops();
            idChuyenVienPhoiHops = gmPhongChuTriDaHoanThanh.getIdChuyenVienPhoiHops();
            spnTenNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getTenPhoPhong()));
            spnPhongNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getTenChuyenVien()));
            tvSKHNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getSoKyHieu()));
            tvNoiGuiNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getNoiGui()));
            tvNgayNDVBDSVBDenChoLDXL.setText(gmPhongChuTriDaHoanThanh.getNgayNhap());
            tvSoDenNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getSoDen()));
            tvTrichYeuNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getMoTa() + "." + gmPhongChuTriDaHoanThanh.getNoiDung()));
            if (gmPhongChuTriDaHoanThanh.getChiDao() != null) {
                tvChiDao1NDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getChiDao()));
            }
            if (gmPhongChuTriDaHoanThanh.getChiDaoChuTri() != null) {
                tvChiDao2NDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getChiDaoChuTri()));
            }
            if (!gmPhongChuTriDaHoanThanh.getGiayMoiGio().isEmpty() && !gmPhongChuTriDaHoanThanh.getGiayMoiNgay().isEmpty() && !gmPhongChuTriDaHoanThanh.getGiayMoiDiaDiem().isEmpty()) {
                tvNgayGio.setText("Vào hồi " + gmPhongChuTriDaHoanThanh.getGiayMoiGio() + "ngày " + gmPhongChuTriDaHoanThanh.getGiayMoiNgay() + ", tại " + gmPhongChuTriDaHoanThanh.getGiayMoiDiaDiem());
            }
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBGiayMoiGiaoPhongChuTriDaHoanThanhActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            if (!gmPhongChuTriDaHoanThanh.getHanGiaiQuyetCV().isEmpty()) {
                tvNgayThangNamNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getHanGiaiQuyetCV()));
            }
            if (!gmPhongChuTriDaHoanThanh.getHanGiaiQuyetPH().isEmpty()) {
                tvNgayThangNamNDVBDSVBDenChoLDXL.setText(String.valueOf(gmPhongChuTriDaHoanThanh.getHanGiaiQuyetPH()));
            }
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvDuyetNDVBDSVBDenChoLDXL:
                getPresenter().duyetGMGiaoPhongChuTriDaHoanThanh(idvb, idPhoPhong, idPhoPhongPhoiHop, idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
    ...
    @Override
    public NDVBGiayMoiGiaoPhongChuTriDaHoanThanhPresenter createPresenter() {
        return new NDVBGiayMoiGiaoPhongChuTriDaHoanThanhPresenterImpl(this);
    }
}
