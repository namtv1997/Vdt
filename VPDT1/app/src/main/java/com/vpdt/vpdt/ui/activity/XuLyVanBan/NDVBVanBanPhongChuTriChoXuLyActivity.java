...
import com.vpdt.vpdt.presenter.impl.NDVB_VanBanPhongChuTriChoXuLyPresenterImpl;
...
public class NDVBVanBanPhongChuTriChoXuLyActivity extends BaseActivity<NDVB_VanBanPhongChuTriChoXuLyPresenter> implements NDVB_VanBanPhongChuTriChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvb_van_ban_phong_chu_tri_cho_xu_ly;
    }
    ...
    public void initializeComponents() {
        ...
        PhongChuTriChoXuLyCC phongChuTriChoXuLyCC = getIntent().getParcelableExtra("phongChuTriChoXuLyCC");
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanPhongChuTriChoXuLyActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    @OnClick({R.id.tvChuyenChiCucPho, R.id.tvChuyenTruongPhong, R.id.btnChonPhoiHop, R.id.tvNgayThangNam,
            R.id.lnNoiDungVB, R.id.btnBack, R.id.btnTuChoi, R.id.tvXemChiTiet, R.id.btnDuyet,})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                ...
                getPresenter().duyetVBPhongChuTriChoXuLyCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), idvb, idChiCuc, idChiCucPho, idTruongPhong, idTruongPhongPP,
            ...
            case R.id.btnTuChoi:
                ...
                tvTieuDe.setText("Từ chối văn bản");
                EditText edtNoiDungTuChoi = viewtuchoi.findViewById(R.id.edtNoiDungTuChoi);
                ...
                btnChuyenChanhVanBan.setText("Chuyển chi cục trưởng");
                btnChuyenChanhVanBan.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        getPresenter().tuChoiVBPhongChuTriChoXuLyCC(PrefUtil.getString(NDVBVanBanPhongChuTriChoXuLyActivity.this, Key.NAM_LAM_VIEC, ""), idvb, edtNoiDungTuChoi.getText().toString(), edtGhiChu.getText().toString());
                    }
                });
                dialog.show();
                break;
    ...
    @Override
    public void tuChoiVBPhongChuTriChoXuLyCC() {
        Toast.makeText(this, "Đã từ chối", Toast.LENGTH_SHORT).show();
        finish();
    }

    @Override
    public NDVB_VanBanPhongChuTriChoXuLyPresenter createPresenter() {
        return new NDVB_VanBanPhongChuTriChoXuLyPresenterImpl(this);
    }
