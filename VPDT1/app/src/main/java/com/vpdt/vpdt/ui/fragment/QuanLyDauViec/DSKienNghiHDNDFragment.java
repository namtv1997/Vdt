...
public class DSKienNghiHDNDFragment extends BaseFragment<DSKienNghiHDND_Presenter> implements DSKienNghiHDNDView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_ds_kien_nghi_hdnd;
    }
    ...
    public void initializeComponents(View view) {
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getPresenter().getallkiennghi(NamLamViec, true);
            }
        });
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            @Override
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getallkiennghi(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countallkiennghi(NamLamViec);
    ...
    @OnClick({R.id.btnNamLamViec, R.id.btnBack, R.id.vDSKNHDND, R.id.lnDSKNHDND, R.id.rlDSKNHDND, R.id.btnHome})
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getallkiennghi(String.valueOf(integer), true);
