...
public class AdapterVanBanChoChiDaoLV2 extends RecyclerView.Adapter<AdapterVanBanChoChiDaoLV2.ViewHolder> {
    private ArrayList<VanBanChoChiDaoLV2> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanChoChiDaoLV2(ArrayList<VanBanChoChiDaoLV2> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChoChiDaoLV2 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChoChiDaoLV2 vanBanChoChiDaoLV2);

        void onItemClickXuLy(VanBanChoChiDaoLV2 vanBanChoChiDaoLV2);

        void onItemClickXemChiTiet(VanBanChoChiDaoLV2 vanBanChoChiDaoLV2);
    }
}
