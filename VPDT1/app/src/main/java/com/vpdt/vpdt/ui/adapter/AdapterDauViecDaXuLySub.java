...
public class AdapterDauViecDaXuLySub extends RecyclerView.Adapter<AdapterDauViecDaXuLySub.ViewHolder> {
    private ArrayList<Item> itemArrayList;
    private OnItemClickListener listener;


    public AdapterDauViecDaXuLySub(ArrayList<Item> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        Item giaHanGiaiQuyet = itemArrayList.get(position);
...
//        if (giaHanGiaiQuyet.get().isEmpty() || giaHanGiaiQuyet.getNoiDungChiDao() == null) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(Item item);

        void onItemClickXuLy(Item item);

        void onItemClickXemChiTiet(Item item);
    }
}
