...
import com.vpdt.vpdt.presenter.VanBanSTCPhoiHopDaChiDaoPresenter;
import com.vpdt.vpdt.presenter.VanBanSTCPhoiHopDaChiDaoView;
import com.vpdt.vpdt.presenter.impl.VanBanSTCPhoiHopDaChiDaoPresenterImpl;
import com.vpdt.vpdt.ui.activity.MainActivity;
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NDVBVBSTCPhoiHopDaChiDaoActivity;
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NDVBVanBanSTCPhoiHopDaChiDaoActivity;
...
public class VanBanSTCPhoiHopDaChiDaoFragment extends BaseFragment<VanBanSTCPhoiHopDaChiDaoPresenter> implements VanBanSTCPhoiHopDaChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_stc_phoi_hop_da_chi_dao;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBSTCPhoiHopDaChiDaoPhong(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBSTCPhoiHopDaChiDaoPhong(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBSTCPhoiHopDaChiDaoPhong(NamLamViec);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBSTCPhoiHopDaChiDaoPhong(String.valueOf(integer), true);
    ...
    @Override
    public VanBanSTCPhoiHopDaChiDaoPresenter createPresenter() {
        return new VanBanSTCPhoiHopDaChiDaoPresenterImpl(this);
    }
    ...
    public void onItemClickXuLy(PhongChuTriDaChiDao phongChuTriDaChiDao) {
        if (!click) {
            if (level == 7) {
                Intent intent = new Intent(getActivity(), NDVBVanBanSTCPhoiHopDaChiDaoActivity.class);
                intent.putExtra("phongChuTriDaChiDao", phongChuTriDaChiDao);
                startActivity(intent);
                click = true;
            } else {
                Intent intent = new Intent(getActivity(), NDVBVBSTCPhoiHopDaChiDaoActivity.class);
                intent.putExtra("phongChuTriDaChiDao", phongChuTriDaChiDao);
                startActivity(intent);
                click = true;
            }
