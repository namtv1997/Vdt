...
import com.vpdt.vpdt.ui.activity.XuLyGiayMoi.NoiDungGiayMoiPhoiHopDaChiDaoActivity;
...
public class GiayMoiPhoiHopDaChiDaoFragment extends BaseFragment<GMGiaoPhongPhoiHopDaChiDaoPresenter> implements GMGiaoPhongPhoiHopDaChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_giay_moi_phoi_hop_da_chi_dao;
    }
    ...
    public void onItemClickXuLy(GMGiaoPhongPhoiHopDaChiDao gmGiaoPhongPhoiHopDaChiDao) {
        if (!click) {
            Intent i = new Intent(getContext(), NoiDungGiayMoiPhoiHopDaChiDaoActivity.class);
    ...
    public void onItemClickXemChiTiet(GMGiaoPhongPhoiHopDaChiDao gmGiaoPhongPhoiHopDaChiDao) {
        if (!click) {
            ...
            intent.putExtra("idvb", gmGiaoPhongPhoiHopDaChiDao.getId());
