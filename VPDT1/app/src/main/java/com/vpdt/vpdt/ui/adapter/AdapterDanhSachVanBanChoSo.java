...
public class AdapterDanhSachVanBanChoSo extends RecyclerView.Adapter<AdapterDanhSachVanBanChoSo.ViewHolder> {
    private ArrayList<DanhSachVanBanDi> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterDanhSachVanBanChoSo(ArrayList<DanhSachVanBanDi> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
