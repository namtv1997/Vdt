...
public class AdapterTepTinDinhKemPhongPH extends RecyclerView.Adapter<AdapterTepTinDinhKemPhongPH.ViewHolder> {
    private ArrayList<TepTinDinhKemPPH> tepDinhKems;
    private OnItemClickListener listener;

    public AdapterTepTinDinhKemPhongPH(ArrayList<TepTinDinhKemPPH> tepDinhKems, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        TepTinDinhKemPPH tepDinhKem = tepDinhKems.get(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(TepTinDinhKemPPH tepTinDinhKemPPH);
    }
}
