...
import com.vpdt.vpdt.presenter.impl.NDVB_VBGiaoPhongPhoiHopChoXuLyPresenterImpl;
...
public class NDVB_VBGiaoPhongPhoiHopChoXuLyActivity extends BaseActivity<NDVB_VBGiaoPhongPhoiHopChoXuLyPresenter> implements
        NDVB_VBGiaoPhongPhoiHopChoXuLyView, AdapterTenGiamDoc.OnItemClickListener, DatePickerDialog.OnDateSetListener,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvb__vbgiao_phong_phoi_hop_cho_xu_ly;
    }
    ...
    public void initializeComponents() {
        ...
        VanBanGiaoPhongPhoiHop vanBanGiaoPhongPhoiHop = getIntent().getParcelableExtra("vanBanGiaoPhongPhoiHop");
        getPresenter().getAllChuyenVien();
        getPresenter().getAllPhoPhongBan();
        if (vanBanGiaoPhongPhoiHop != null) {
            idvb = vanBanGiaoPhongPhoiHop.getId();
            tvSKH.setText(String.valueOf(vanBanGiaoPhongPhoiHop.getSoKyHieu()));
            tvSoDen.setText(String.valueOf(vanBanGiaoPhongPhoiHop.getSoDen()));
            tvNoigui.setText(String.valueOf(vanBanGiaoPhongPhoiHop.getNoiGui()));
            tvNgay.setText(String.valueOf(vanBanGiaoPhongPhoiHop.getNgayNhap()));
            tvNgayThangNam.setText(String.valueOf(vanBanGiaoPhongPhoiHop.getHanGiaiQuyet()));
            tvTrichYeu.setText(vanBanGiaoPhongPhoiHop.getMoTa() + " . " + vanBanGiaoPhongPhoiHop.getNoiDung());
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVB_VBGiaoPhongPhoiHopChoXuLyActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTietNDVBDSVBDenChoLDXL:
                try {
                    if (!click) {
                        Intent intent = new Intent(this, TTVB_VBGiaoPhongPhoiHopXuLyActivity.class);
                        intent.putExtra("idVbPhongPhoiHop", idvb);
            ...
            case R.id.btnDuyet:
                getPresenter().duyetVBPhongPhoiHopChoXuLy(idvb, idPhoPhong, idPhoPhongPhoiHop, idChuyenVienPhoiHops, tvChiDao1.getText().toString(), tvChiDao2.getText().toString(), tvNgayThangNam.getText().toString());
                break;
    ...
    @Override
    public NDVB_VBGiaoPhongPhoiHopChoXuLyPresenter createPresenter() {
        return new NDVB_VBGiaoPhongPhoiHopChoXuLyPresenterImpl(this);
    }
