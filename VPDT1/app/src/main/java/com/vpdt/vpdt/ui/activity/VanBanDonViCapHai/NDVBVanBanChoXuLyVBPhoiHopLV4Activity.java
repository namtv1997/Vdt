...
public class NDVBVanBanChoXuLyVBPhoiHopLV4Activity extends BaseActivity<NDVBVanBanChoXuLyLV4Presenter> implements NDVBVanBanChoXuLyLV4View,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_cho_xu_ly_vbphoi_hop;
    }
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanChoXuLyVBPhoiHopLV4Activity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBChoXuLyPPhoiHopDonViCapHai(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
