...
import com.vpdt.vpdt.presenter.impl.NDVBVBPhongChuTriDaChiDaoPresenterImpl;
...
public class NDVBVBPhongChuTriDaChiDaoActivity extends BaseActivity<NDVBVBPhongChuTriDaChiDaoPresenter> implements NDVBVBPhongChuTriDaChiDaoView,
    ...
    @BindView(R.id.rlPhoPhong)
    RelativeLayout rlPhoPhong;
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvbphong_chu_tri_da_chi_dao;
    }
    ...
    public void initializeComponents() {
        ...
        if (level == 7) {
            rlPhoPhong.setVisibility(View.GONE);
        ...
        if (phongChuTriDaChiDao != null) {
            ...
            spnTenNDVBDSVBDenChoLDXL.setText(String.valueOf(phongChuTriDaChiDao.getTenPhoPhong()));
            ...
            tvChiDao1NDVBDSVBDenChoLDXL.setText(String.valueOf(phongChuTriDaChiDao.getChiDao()));
            tvChiDao2NDVBDSVBDenChoLDXL.setText(String.valueOf(phongChuTriDaChiDao.getChiDaoChuTri()));
            ...
            tvNoiDung.setText(String.valueOf(phongChuTriDaChiDao.getNoiDung()));
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVBPhongChuTriDaChiDaoActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    @Override
    public NDVBVBPhongChuTriDaChiDaoPresenter createPresenter() {
        return new NDVBVBPhongChuTriDaChiDaoPresenterImpl(this);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvDuyetNDVBDSVBDenChoLDXL:
                if (level == 7) {
                    if (cbVbQuanTrong.isChecked() && cbPGDBietDeDonDoc.isChecked()) {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, 0, "", idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, true, true, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                    } else if (cbPGDBietDeDonDoc.isChecked()) {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, 0, "", idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, false, true, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                    } else if (cbVbQuanTrong.isChecked()) {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, 0, "", idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, true, false, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                    } else {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, 0, "", idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, false, false, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                    }

                } else {

                    if (cbVbQuanTrong.isChecked() && cbPGDBietDeDonDoc.isChecked()) {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, idPhoPhong, idPhoPhongPhoiHop, idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, true, true, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                    } else if (cbPGDBietDeDonDoc.isChecked()) {
                        getPresenter().duyetVBPhongChuTriDaChiDao(idvb, idPhoPhong, idPhoPhongPhoiHop, idChuyenVien, idChuyenVienPhoiHops, tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(),
                                tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(), vanbandauraTruongPhong, false, true, tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
