...
public class AdapterVanBanChoChiDao extends RecyclerView.Adapter<AdapterVanBanChoChiDao.ViewHolder> {
    private ArrayList<VanBanChoChiDao> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanChoChiDao(ArrayList<VanBanChoChiDao> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChoChiDao giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChoChiDao vanBanChoChiDao);

        void onItemClickXuLy(VanBanChoChiDao vanBanChoChiDao);

        void onItemClickXemChiTiet(VanBanChoChiDao vanBanChoChiDao);
    }
}
