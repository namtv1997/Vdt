...
public class AdapterDauViecPhongChuTriChoXuLyCC1 extends RecyclerView.Adapter<AdapterDauViecPhongChuTriChoXuLyCC1.ViewHolder> {
    private ArrayList<ItemDauViecPhongChuTriChoXuLyCC> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecPhongChuTriChoXuLyCC1(ArrayList<ItemDauViecPhongChuTriChoXuLyCC> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViecPhongChuTriChoXuLyCC giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViecPhongChuTriChoXuLyCC itemDauViecPhongChuTriChoXuLyCC);

        void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLyCC itemDauViecPhongChuTriChoXuLyCC);

        void onItemClickXemChiTiet(ItemDauViecPhongChuTriChoXuLyCC itemDauViecPhongChuTriChoXuLyCC);
    }
}
