...
public class AdapterGiayMoiChoLanhDaoXuLy extends RecyclerView.Adapter<AdapterGiayMoiChoLanhDaoXuLy.ViewHolder> {
    private ArrayList<GiayMoiChoLanhDaoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private Context mContext;
    private OnItemClickListener listener;


    public AdapterGiayMoiChoLanhDaoXuLy(Context mContext, ArrayList<GiayMoiChoLanhDaoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiChoLanhDaoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
        ...
        viewHolder.tvHanXuLy.setText(String.valueOf("Hạn giải quyết: " + giaHanGiaiQuyet.getHanGiaquyet()));
        if (giaHanGiaiQuyet.getHanGiaquyet() == null) {
            viewHolder.tvHanXuLy.setVisibility(View.GONE);
        } else {
            if (giaHanGiaiQuyet.getHanGiaquyet().isEmpty()) {
                viewHolder.tvHanXuLy.setVisibility(View.GONE);
            } else {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiChoLanhDaoXuLy giayMoiChoLanhDaoXuLy);

        void onItemClickXuLy(GiayMoiChoLanhDaoXuLy giayMoiChoLanhDaoXuLy);

        void onItemClickXemChiTiet(GiayMoiChoLanhDaoXuLy giayMoiChoLanhDaoXuLy);
    }
}
