...
public class NDVBDauViecPhongChuTriChoXuLyPresenterImpl extends BasePresenterImpl<NDVBDauViecPhongChuTriChoXuLyView> implements NDVBDauViecPhongChuTriChoXuLyPresenter {
    public NDVBDauViecPhongChuTriChoXuLyPresenterImpl(NDVBDauViecPhongChuTriChoXuLyView view) {
        super(view);
    }
    ...
    @Override
    public void duyetDauViecPhongChuTriChoXuLy(int id, int idPhoPhong, String tenPhoPhong, String idPhoPhongPhoiHops,
                                               String tenPhoPhongPhoiHops, int idChuyenVien,
                                               String tenChuyenVien, String idChuyenVienPhoiHops,
                                               String tenChuyenVienPhoiHops, String hanXuLy) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetDauViecPhongChuTriChoXuLy(token, id, idPhoPhong, tenPhoPhong, idPhoPhongPhoiHops, tenPhoPhongPhoiHops, idChuyenVien, tenChuyenVien, idChuyenVienPhoiHops, tenChuyenVienPhoiHops, hanXuLy)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
