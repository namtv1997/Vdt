...
public class AdapterGiayMoiPhongChuTriDaChiDao extends RecyclerView.Adapter<AdapterGiayMoiPhongChuTriDaChiDao.ViewHolder> {
    private ArrayList<GMPhongChuTriDaChiDao> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiPhongChuTriDaChiDao(ArrayList<GMPhongChuTriDaChiDao> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GMPhongChuTriDaChiDao giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GMPhongChuTriDaChiDao gmPhongChuTriDaChiDao);

        void onItemClickXuLy(GMPhongChuTriDaChiDao gmPhongChuTriDaChiDao);

        void onItemClickXemChiTiet(GMPhongChuTriDaChiDao gmPhongChuTriDaChiDao);
    }
}
