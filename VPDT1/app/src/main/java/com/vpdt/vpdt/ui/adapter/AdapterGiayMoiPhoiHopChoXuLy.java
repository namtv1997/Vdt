...
public class AdapterGiayMoiPhoiHopChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiPhoiHopChoXuLy.ViewHolder> {
    private ArrayList<GMPhoiHopChoXL> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiPhoiHopChoXuLy(ArrayList<GMPhoiHopChoXL> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GMPhoiHopChoXL giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GMPhoiHopChoXL gmPhoiHopChoXL);

        void onItemClickXuLy(GMPhoiHopChoXL gmPhoiHopChoXL);

        void onItemClickXemChiTiet(GMPhoiHopChoXL gmPhoiHopChoXL);
    }
}
