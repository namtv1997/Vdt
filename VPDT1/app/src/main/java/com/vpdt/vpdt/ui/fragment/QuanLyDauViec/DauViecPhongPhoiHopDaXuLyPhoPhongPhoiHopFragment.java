...
public class DauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopFragment extends BaseFragment<DauViecPhongPhoiHopDaChiDaoChuaHTPresenter> implements DauViecPhongPhoiHopDaChiDaoChuaHTView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_phong_phoi_hop_da_xu_ly_pho_phong_phoi_hop;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongPhoHopDaChiDao(NamLamViec, true);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongPhoHopDaChiDao(String.valueOf(integer), true);
