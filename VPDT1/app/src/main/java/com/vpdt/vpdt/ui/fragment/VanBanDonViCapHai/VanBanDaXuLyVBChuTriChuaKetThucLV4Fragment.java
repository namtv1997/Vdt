...
import com.vpdt.vpdt.ui.activity.VanBanDonViCapHai.NDVBVanBanChoXuLyVBChuTriLV4Activity;
...
public class VanBanDaXuLyVBChuTriChuaKetThucLV4Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV4Presenter> implements VanBanChoXuLyVBChuTriLV4View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_da_xu_ly_vb_chu_tri_chua_ket_thuc_lv3;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBDaXuLyPPChuTriDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBDaXuLyPPChuTriDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBDaXuLyPPChuTriDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBDaXuLyPPChuTriDonViCapHai(String.valueOf(integer), true);
    ...
    public void onItemClickXuLy(VanBanChoXuLyVBChuTriLV4 vanBanChoXuLyVBChuTriLV4) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVBVanBanChoXuLyVBChuTriLV4Activity.class);
