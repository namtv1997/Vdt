...
import com.vpdt.vpdt.presenter.NDVBDauViecPhongChuTriDaChiDaoChuaHTPresenter;
import com.vpdt.vpdt.presenter.NDVBDauViecPhongChuTriDaChiDaoChuaHTView;
import com.vpdt.vpdt.presenter.impl.NDVBDauViecPhongChuTriDaChiDaoChuaHTPresenterImpl;
...
public class NDVBDauViecPhongChuTriDaChiDaoChuaHTActivity extends BaseActivity<NDVBDauViecPhongChuTriDaChiDaoChuaHTPresenter> implements NDVBDauViecPhongChuTriDaChiDaoChuaHTView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_phong_chu_tri_da_chi_dao_chua_ht;
    }
    ...
    public void initializeComponents() {
        ...
        if (itemDauViecPhongChuTriDaChiDaoChuaHoanThanh != null) {
            ...
            edtChiDao4.setText(String.valueOf(itemDauViecPhongChuTriDaChiDaoChuaHoanThanh.getTenChuyenVienPhoiHops()));
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnDuyet:
                if (level == 7) {
                    getPresenter().duyetDauViecPhongChuTriDaChiDao(id, 0, "", "", "", idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                } else {
                    getPresenter().duyetDauViecPhongChuTriDaChiDao(id, idPhoPhong, tenPhoPhong, idPhoPhongPhoiHop, tenPhoPhongPhoiHop, idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                }
                break;
    ...
    @Override
    public NDVBDauViecPhongChuTriDaChiDaoChuaHTPresenter createPresenter() {
        return new NDVBDauViecPhongChuTriDaChiDaoChuaHTPresenterImpl(this);
    }
}
