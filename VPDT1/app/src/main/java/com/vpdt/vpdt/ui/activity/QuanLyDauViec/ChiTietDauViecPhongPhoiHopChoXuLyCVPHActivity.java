...
import com.vpdt.vpdt.presenter.ChiTietDauViecPhongPhoiHopChoXuLyCVPHPresenter;
import com.vpdt.vpdt.presenter.ChiTietDauViecPhongPhoiHopChoXuLyCVPHView;
import com.vpdt.vpdt.presenter.impl.ChiTietDauViecPhongPhoiHopChoXuLyCVPHPresenterImpl;
...
public class ChiTietDauViecPhongPhoiHopChoXuLyCVPHActivity extends BaseActivity<ChiTietDauViecPhongPhoiHopChoXuLyCVPHPresenter> implements ChiTietDauViecPhongPhoiHopChoXuLyCVPHView,
    ...
    public int getContentViewId() {
        return R.layout.activity_chi_tiet_dau_viec_phong_phoi_hop_cho_xu_ly_cvph;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("idvb")) {
                ...
                getPresenter().getChiTietDauViecPH(idvb);
            }
        }
    }
        ...
        tvFileVanBan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ChiTietDauViecPhongPhoiHopChoXuLyCVPHActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    @Override
    public ChiTietDauViecPhongPhoiHopChoXuLyCVPHPresenter createPresenter() {
        return new ChiTietDauViecPhongPhoiHopChoXuLyCVPHPresenterImpl(this);
    }
