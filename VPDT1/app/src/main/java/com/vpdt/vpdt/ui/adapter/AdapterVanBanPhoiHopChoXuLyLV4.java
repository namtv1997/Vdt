...
public class AdapterVanBanPhoiHopChoXuLyLV4 extends RecyclerView.Adapter<AdapterVanBanPhoiHopChoXuLyLV4.ViewHolder> {
    private ArrayList<VanBanPhoiHopChoXuLyLV4> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanPhoiHopChoXuLyLV4(ArrayList<VanBanPhoiHopChoXuLyLV4> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanPhoiHopChoXuLyLV4 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
        ...
        viewHolder.tvNguoiNhap.setText(String.valueOf("Nội dung chỉ đạo của đ/c " + giaHanGiaiQuyet.getCanBoChiDao() + ":\n" +
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanPhoiHopChoXuLyLV4 vanBanPhoiHopChoXuLyLV4);

        void onItemClickXuLy(VanBanPhoiHopChoXuLyLV4 vanBanPhoiHopChoXuLyLV4);

        void onItemClickXemChiTiet(VanBanPhoiHopChoXuLyLV4 vanBanPhoiHopChoXuLyLV4);
    }
}
