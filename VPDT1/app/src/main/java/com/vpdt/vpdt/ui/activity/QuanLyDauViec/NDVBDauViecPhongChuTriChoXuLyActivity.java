...
public class NDVBDauViecPhongChuTriChoXuLyActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyPresenter> implements NDVBDauViecPhongChuTriChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_phong_chu_tri_cho_xu_ly;
    }
    ...
    public void initializeComponents() {
        ...
        if (level == 7) {
            tvChuyenPhoPhong.setVisibility(View.GONE);
        ...
        if (itemDanhSachDauViecQuaHanCuaPhong != null) {
            ...
            tvChonChuyenVien1.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getTenChuyenVien()));
            tvNgayThangNam.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getHanXuLy()));
            edtChiDao3.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getChiDao()));
            edtChiDao4.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getChidaoChuTri()));
...
//            edtChiDao2.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.get));
            edtChiDao3.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getChidaoChuTri()));
//            edtChiDao4.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.get));
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnChonPhoPhongPhoiHop:
                if (tvChuyenPhoPhong.getText().toString().isEmpty()) {
            ...
            case R.id.btnChonPhoiHop:
                if (tvChonChuyenVien1.getText().toString().isEmpty()) {
            ...
            case R.id.btnDuyet:
                if (level == 7) {
                    getPresenter().duyetDauViecPhongChuTriChoXuLy(id, 0, "", "", "", idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                } else {
                    getPresenter().duyetDauViecPhongChuTriChoXuLy(id, idPhoPhong, tenPhoPhong, idPhoPhongPhoiHop, tenPhoPhongPhoiHop, idChuyenVien, tenChuyenvien, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                }
                break;
    ...
    @Override
    public NDVBDauViecPhongChuTriChoXuLyPresenter createPresenter() {
        return new NDVBDauViecPhongChuTriChoXuLyPresenterImpl(this);
    }
