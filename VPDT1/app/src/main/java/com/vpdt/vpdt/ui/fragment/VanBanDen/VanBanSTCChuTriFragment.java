...
public class VanBanSTCChuTriFragment extends BaseFragment<DanhSachCongTacDangPresenter>
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_stc_chu_tri;
    }
    ...
    public void onStart() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().getallvbdentongthe(3, 0, NamLamViec, true);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().getallvbdentongthe(3, 1, NamLamViec, true);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().getallvbdentongthe(3, 2, NamLamViec, true);
        }
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (TenVB.getText() == "-- Tất cả --") {
                    getPresenter().getallvbdentongthe(3, 0, NamLamViec, false);
                } else if (TenVB.getText() == "Văn bản mới nhập") {
                    getPresenter().getallvbdentongthe(3, 1, NamLamViec, false);
                } else if (TenVB.getText() == "Đã giải quyết") {
                    getPresenter().getallvbdentongthe(3, 2, NamLamViec, false);
                }
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().countvbden(3, 0, NamLamViec);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().countvbden(3, 1, NamLamViec);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().countvbden(3, 2, NamLamViec);
        }
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().getallvbdentongthe(3, 0, String.valueOf(integer), true);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().getallvbdentongthe(3, 1, String.valueOf(integer), true);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().getallvbdentongthe(3, 2, String.valueOf(integer), true);
        }
