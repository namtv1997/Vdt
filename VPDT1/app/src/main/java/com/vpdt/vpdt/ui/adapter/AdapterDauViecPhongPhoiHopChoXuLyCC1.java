...
public class AdapterDauViecPhongPhoiHopChoXuLyCC1 extends RecyclerView.Adapter<AdapterDauViecPhongPhoiHopChoXuLyCC1.ViewHolder> {
    private ArrayList<ItemDauViecPhongPhoiHopChoXuLyCC> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecPhongPhoiHopChoXuLyCC1(ArrayList<ItemDauViecPhongPhoiHopChoXuLyCC> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViecPhongPhoiHopChoXuLyCC giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViecPhongPhoiHopChoXuLyCC itemDauViecPhongPhoiHopChoXuLyCC);

        void onItemClickXuLy(ItemDauViecPhongPhoiHopChoXuLyCC itemDauViecPhongPhoiHopChoXuLyCC);

        void onItemClickXemChiTiet(ItemDauViecPhongPhoiHopChoXuLyCC itemDauViecPhongPhoiHopChoXuLyCC);
    }
}
