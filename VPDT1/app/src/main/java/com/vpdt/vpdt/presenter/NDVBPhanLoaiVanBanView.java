...
public interface NDVBPhanLoaiVanBanView extends BaseView<NDVBPhanLoaiVanBanPresenter> {
    Context gContext();
    ...
    void themNoidungVBChuaPhanLoaiSuccess();

    void duyetVBChuaPhanLoaiSuccess();
}
