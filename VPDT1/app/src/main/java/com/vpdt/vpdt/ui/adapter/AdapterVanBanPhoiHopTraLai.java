...
public class AdapterVanBanPhoiHopTraLai extends RecyclerView.Adapter<AdapterVanBanPhoiHopTraLai.ViewHolder> {
    private ArrayList<VanBanPhoiHopTraLai> vanBanGiaoPhongPhoiHopArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanPhoiHopTraLai(ArrayList<VanBanPhoiHopTraLai> vanBanGiaoPhongPhoiHopArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanPhoiHopTraLai dsvb_daChiDao = vanBanGiaoPhongPhoiHopArrayList.get(position);
...
//        } else {
//            viewHolder.tvLoaiVanBan.setText(String.valueOf("Loại văn bản: " + dsvb_daChiDao.get()));
//        }
...
//        if (dsvb_daChiDao.getng().isEmpty() || dsvb_daChiDao.getNguoiNhap() == null) {
...
//        if (dsvb_daChiDao.getSoTrang().isEmpty() || dsvb_daChiDao.getSoTrang() == null) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanPhoiHopTraLai vanBanPhoiHopTraLai);

        void onItemClickXuLy(VanBanPhoiHopTraLai vanBanPhoiHopTraLai);

        void onItemClickXemChiTiet(VanBanPhoiHopTraLai vanBanPhoiHopTraLai);
    }
}
