...
public class NDVBDauViecTruongPhongPhoiHopPhongCTTPCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyTPCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyViewTPCC,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_truong_phong_phoi_hop_phong_cttpcc;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvNgayThangNam:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecTruongPhongPhoHopCT(PrefUtil.getString(NDVBDauViecTruongPhongPhoiHopPhongCTTPCCActivity.this, Key.NAM_LAM_VIEC, ""),
