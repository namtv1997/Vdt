...
public class VanBanHDNDHaNoiActivity extends BaseActivity<DanhSachCongTacDangPresenter>
    ...
    public void initializeComponents() {
        ...
        tvTenVanban.setText("Văn bản HĐND Thành Phố HN");
    }
    ...
    public void onStart() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().getallvbdentongthe(8, 0, NamLamViec, true);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().getallvbdentongthe(8, 1, NamLamViec, true);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().getallvbdentongthe(8, 2, NamLamViec, true);
        }
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (TenVB.getText() == "-- Tất cả --") {
                    getPresenter().getallvbdentongthe(8, 0, NamLamViec, false);
                } else if (TenVB.getText() == "Văn bản mới nhập") {
                    getPresenter().getallvbdentongthe(8, 1, NamLamViec, false);
                } else if (TenVB.getText() == "Đã giải quyết") {
                    getPresenter().getallvbdentongthe(8, 2, NamLamViec, false);
                }
    ...
    public void onGetDataSuccess() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().countvbden(8, 0, NamLamViec);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().countvbden(8, 1, NamLamViec);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().countvbden(8, 2, NamLamViec);
        }
    }
