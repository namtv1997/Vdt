...
public class AdapterVanBanChoXuLyLV4 extends RecyclerView.Adapter<AdapterVanBanChoXuLyLV4.ViewHolder> {
    private ArrayList<VanBanChoXuLyVBChuTriLV4> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanChoXuLyLV4(ArrayList<VanBanChoXuLyVBChuTriLV4> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChoXuLyVBChuTriLV4 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChoXuLyVBChuTriLV4 vanBanChoXuLyVBChuTriLV4);

        void onItemClickXuLy(VanBanChoXuLyVBChuTriLV4 vanBanChoXuLyVBChuTriLV4);

        void onItemClickXemChiTiet(VanBanChoXuLyVBChuTriLV4 vanBanChoXuLyVBChuTriLV4);
    }
}
