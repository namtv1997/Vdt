...
public class GiayMoiGiaoChuTriChoXuLy implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    protected GiayMoiGiaoChuTriChoXuLy(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
    ...
    public static final Creator<GiayMoiGiaoChuTriChoXuLy> CREATOR = new Creator<GiayMoiGiaoChuTriChoXuLy>() {
        @Override
        public GiayMoiGiaoChuTriChoXuLy createFromParcel(Parcel in) {
            return new GiayMoiGiaoChuTriChoXuLy(in);
        }

        @Override
        public GiayMoiGiaoChuTriChoXuLy[] newArray(int size) {
            return new GiayMoiGiaoChuTriChoXuLy[size];
        }
    };
