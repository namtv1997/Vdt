...
public class AdapterGiayMoiPhoPhongPhoiHopChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiPhoPhongPhoiHopChoXuLy.ViewHolder> {
    private ArrayList<GiayMoiPhongPhoiHopChoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiPhoPhongPhoiHopChoXuLy(ArrayList<GiayMoiPhongPhoiHopChoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiPhongPhoiHopChoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiPhongPhoiHopChoXuLy giayMoiPhongPhoiHopChoXuLy);

        void onItemClickXuLy(GiayMoiPhongPhoiHopChoXuLy giayMoiPhongPhoiHopChoXuLy);

        void onItemClickXemChiTiet(GiayMoiPhongPhoiHopChoXuLy giayMoiPhongPhoiHopChoXuLy);
    }
}
