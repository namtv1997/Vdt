...
public class DanhSachPhongChuTriDaChiDaoChuaHTTPCCFragment extends BaseFragment<DauViecPhongChuTriDaChiDaoChuaHTPresenter> implements DauViecPhongChuTriDaChiDaoChuaHTView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_phong_chu_tri_da_chi_dao_cht_tpcc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongChuTriDaXuLyTPCC(NamLamViec);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongChuTriDaXuLyTPCC(String.valueOf(integer));
