...
public class TTVBVanBanXemDeBietActivity extends BaseActivity<NDVBVanBanXemDeBietPresenter> implements NDVBVanBanXemDeBietView, AdapterTepTinDinhKemVanBanDi.OnItemClickListener, AdapterSoDen.OnItemClickListener {
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbvan_ban_xem_de_biet;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("ID_VANBAN_XEM_DE_BIET")) {
                idvb = intent.getIntExtra("ID_VANBAN_XEM_DE_BIET", 0);
