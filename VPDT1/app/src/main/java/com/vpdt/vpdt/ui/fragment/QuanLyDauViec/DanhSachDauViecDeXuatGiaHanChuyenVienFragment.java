...
public class DanhSachDauViecDeXuatGiaHanChuyenVienFragment extends BaseFragment<DanhSachDauViecDeXuatGiaHanPresenter> implements DanhSachDauViecDeXuatGiaHanView,
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecDeXuatGiaHanChoDuyetCV(NamLamViec, 0, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllDauViecDeXuatGiaHanChoDuyetCV(NamLamViec, 0, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllDauViecDeXuatGiaHanChoDuyetCV(NamLamViec, 0);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecDeXuatGiaHanChoDuyetCV(String.valueOf(integer), 0, true);
    ...
    public void onItemClickXemChiTiet(DeXuatGiaHanChoDuyet deXuatGiaHanChoDuyet) {
        if (!click) {
            ...
            intent.putExtra("iddv", deXuatGiaHanChoDuyet.getId());
            startActivity(intent);
            click = true;
        }
