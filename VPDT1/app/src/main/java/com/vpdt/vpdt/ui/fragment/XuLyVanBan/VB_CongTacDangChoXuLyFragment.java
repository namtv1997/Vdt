...
import com.vpdt.vpdt.presenter.impl.VB_CongTacDangChoXuLyPresenterImpl;
import com.vpdt.vpdt.ui.activity.MainActivity;
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NDVB_VB_CongTacDangChoXuLyActivity;
import com.vpdt.vpdt.ui.activity.XuLyVanBan.TTVBVanBanCongTacDangChoXuLyActivity;
...
public class VB_CongTacDangChoXuLyFragment extends BaseFragment<VB_CongTacDangChoXuLyPresenter> implements VB_CongTacDangChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_vb_congtacdangchoxuly;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBCongTacDangChoXuLyPhong(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBCongTacDangChoXuLyPhong(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBCongTacDangChoXuLyPhong(NamLamViec);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBCongTacDangChoXuLyPhong(String.valueOf(integer), true);
    ...
    @Override
    public VB_CongTacDangChoXuLyPresenter createPresenter() {
        return new VB_CongTacDangChoXuLyPresenterImpl(this);
    }
    ...
    public void onItemClickXuLy(PhongChuTriChoXL phongChuTri) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVB_VB_CongTacDangChoXuLyActivity.class);
    ...
    public void onItemClickXemChiTiet(PhongChuTriChoXL phongChuTri) {
        try {
            if (!click) {
                Intent intent = new Intent(getActivity(), TTVBVanBanCongTacDangChoXuLyActivity.class);
                intent.putExtra("idvb", phongChuTri.getId());
                startActivity(intent);
                click = true;
            }
        } catch (Exception e) {
