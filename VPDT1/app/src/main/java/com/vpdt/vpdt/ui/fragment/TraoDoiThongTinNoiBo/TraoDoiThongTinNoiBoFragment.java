...
public class TraoDoiThongTinNoiBoFragment extends BaseFragment<MainPresenter> implements MainView,
    ...
    public void initializeComponents(View view) {
        ...
        getPresenter().getMenu(NamLamViec, Key.TDTTNB, String.valueOf(false));
    ...
    private void switchKey(String key) {
        switch (key) {
            case Key.ThongTin_Moi:
                ThongTinMoiFragment thongTinMoiFragment = new ThongTinMoiFragment();
                replaceFragment(thongTinMoiFragment, R.id.fl);
                break;
            case Key.TT_DaGuiDi:
                ThongTinDaGuiDiFragment thongTinDaGuiDiFragment = new ThongTinDaGuiDiFragment();
                replaceFragment(thongTinDaGuiDiFragment, R.id.fl);
                break;
            case Key.TT_DaXem:
                ThongTinDaXemFragment thongTinDaXemFragment = new ThongTinDaXemFragment();
                replaceFragment(thongTinDaXemFragment, R.id.fl);
                break;
            case Key.SoanThao_ThongTin:
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getMenu(String.valueOf(integer), Key.TDTTNB, String.valueOf(false));
