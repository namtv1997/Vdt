...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecChoXuLyActivity;
...
public class AdapterDauViecChoXuLy1 extends RecyclerView.Adapter<AdapterDauViecChoXuLy1.ViewHolder> implements AdapterDauViecDaXuLySub.OnItemClickListener {
    ...
    public AdapterDauViecChoXuLy1(Context mContext, ArrayList<DauViecChoXuLy> danhSachDauViecPhongPhoiHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(Item item) {
        Intent i = new Intent(mContext, NDVBDauViecChoXuLyActivity.class);
