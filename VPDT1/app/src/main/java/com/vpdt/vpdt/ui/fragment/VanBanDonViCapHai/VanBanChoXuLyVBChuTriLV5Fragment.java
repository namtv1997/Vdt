...
public class VanBanChoXuLyVBChuTriLV5Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV5Presenter> implements VanBanChoXuLyVBChuTriLV5View,
        AdapterVanBanChoXuLyLV5.OnItemClickListener,
    ...
    private AdapterVanBanChoXuLyLV5 listAdapter1;
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBChoXuLyCVChuTriDonViCapHai(NamLamViec, true);
        listAdapter1 = new AdapterVanBanChoXuLyLV5(getPresenter().VAN_BAN_CHO_XU_LY_LV_5_ARRAY_LIST(), this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerviewChoXuLy.setLayoutManager(layoutManager);
        recyclerviewChoXuLy.setAdapter(listAdapter1);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBChoXuLyCVChuTriDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBChoXuLyCVChuTriDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBChoXuLyCVChuTriDonViCapHai(String.valueOf(integer), true);
