...
public class VanBanPhoiHopChoXuLyLV5Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV5Presenter> implements VanBanChoXuLyVBChuTriLV5View,
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBPhoiHopChoXuLyCVDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBPhoiHopChoXuLyCVDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBPhoiHopChoXuLyCVDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBPhoiHopChoXuLyCVDonViCapHai(String.valueOf(integer), true);
