...
public class NDVBDauViecPhongChuTriChoXuLyTPCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyTPCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyViewTPCC,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdau_viec_phong_chu_tri_cho_xu_ly_tpcc;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvNgayThangNam:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongChuTriChoXuLyTPCC(PrefUtil.getString(NDVBDauViecPhongChuTriChoXuLyTPCCActivity.this, Key.NAM_LAM_VIEC, ""),
