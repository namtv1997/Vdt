...
public class DetailGiayMoiPhongChuTriChoXuLy {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @SerializedName("showfromHoanThanh")
    @Expose
    private Boolean showfromHoanThanh;
    ...
    public Boolean getShowfromHoanThanh() {
        return showfromHoanThanh;
    }

    public void setShowfromHoanThanh(Boolean showfromHoanThanh) {
        this.showfromHoanThanh = showfromHoanThanh;
    }
}
