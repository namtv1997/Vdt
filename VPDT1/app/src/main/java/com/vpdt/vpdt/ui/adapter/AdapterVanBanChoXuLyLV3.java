...
public class AdapterVanBanChoXuLyLV3 extends RecyclerView.Adapter<AdapterVanBanChoXuLyLV3.ViewHolder> {
    private ArrayList<VanBanChoXuLyLV3> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanChoXuLyLV3(ArrayList<VanBanChoXuLyLV3> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChoXuLyLV3 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChoXuLyLV3 vanBanChoXuLyLV3);

        void onItemClickXuLy(VanBanChoXuLyLV3 vanBanChoXuLyLV3);

        void onItemClickXemChiTiet(VanBanChoXuLyLV3 vanBanChoXuLyLV3);
    }
}
