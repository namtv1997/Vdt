...
public class TTVBGiayMoiGiaoPhongChuTriDaHoanThanhActivity extends BaseActivity<TTVBGiayMoiPhongChuTriChoXuLyPresenter> implements TTVBGiayMoiPhongChuTriChoXuLyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbgiay_moi_giao_phong_chu_tri_da_hoan_thanh;
    }
    ...
    @OnClick({R.id.imvBack, R.id.tvThongTinVanBan,
            ...
            R.id.tvKetQuaGiaiQuyetPThuLy, R.id.tvTrinhTuHoanThanhCV})
