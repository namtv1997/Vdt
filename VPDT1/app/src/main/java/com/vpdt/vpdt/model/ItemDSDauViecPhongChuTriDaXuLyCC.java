...
public class ItemDSDauViecPhongChuTriDaXuLyCC implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("moTa")
    ...
    protected ItemDSDauViecPhongChuTriDaXuLyCC(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
    ...
    public static final Creator<ItemDSDauViecPhongChuTriDaXuLyCC> CREATOR = new Creator<ItemDSDauViecPhongChuTriDaXuLyCC>() {
        @Override
        public ItemDSDauViecPhongChuTriDaXuLyCC createFromParcel(Parcel in) {
            return new ItemDSDauViecPhongChuTriDaXuLyCC(in);
        }

        @Override
        public ItemDSDauViecPhongChuTriDaXuLyCC[] newArray(int size) {
            return new ItemDSDauViecPhongChuTriDaXuLyCC[size];
        }
    };
