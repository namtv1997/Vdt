...
public class AdapterVanBanNguoiDungXuLy extends RecyclerView.Adapter<AdapterVanBanNguoiDungXuLy.ViewHolder> {
    private ArrayList<VanBanNguoiDungXuLy> ToCongTacList;
    private OnItemClickListener listener;


    public AdapterVanBanNguoiDungXuLy(ArrayList<VanBanNguoiDungXuLy> ToCongTacList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanNguoiDungXuLy giaHanGiaiQuyet = ToCongTacList.get(position);
        ...
        viewHolder.tvHanXuLy.setText(String.valueOf("Hạn nhập: " + giaHanGiaiQuyet.getHanGiaiQuyet()));
        ...
        if (giaHanGiaiQuyet.getSoTrang() == null) {
            if (giaHanGiaiQuyet.getGiayMoiGio() == null) {
                ...
                if (giaHanGiaiQuyet.getGiayMoiGio().isEmpty()) {
                    ...
                    viewHolder.tvSoTrang.setText(String.valueOf("(Vào hồi: "
                            ...
                            + giaHanGiaiQuyet.getGiayMoiDiaDiem() + ") "+ giaHanGiaiQuyet.getChuTri()));
                }
            }
        } else {
            if (giaHanGiaiQuyet.getSoTrang().toString().isEmpty()) {
                ...
                if (giaHanGiaiQuyet.getGiayMoiGio() == null) {
                    viewHolder.tvSoTrang.setVisibility(View.VISIBLE);
                    viewHolder.tvSoTrang.setText(String.valueOf("(Số trang: " + giaHanGiaiQuyet.getSoTrang() + ") "+ giaHanGiaiQuyet.getChuTri()));
                } else {
                    if (giaHanGiaiQuyet.getGiayMoiGio().isEmpty()) {
                        viewHolder.tvSoTrang.setVisibility(View.VISIBLE);
                        viewHolder.tvSoTrang.setText(String.valueOf("(Số trang: " + giaHanGiaiQuyet.getSoTrang() + ") "+ giaHanGiaiQuyet.getChuTri()));
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanNguoiDungXuLy vanBanNguoiDungXuLy);

        void onItemClickXuLy(VanBanNguoiDungXuLy vanBanNguoiDungXuLy);

        void onItemClickXemChiTiet(VanBanNguoiDungXuLy vanBanNguoiDungXuLy);
    }
}
