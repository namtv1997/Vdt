...
import com.vpdt.vpdt.presenter.impl.NoiDungGiayMoiPhoiHopDaChiDaoPresenterImpl;
...
public class NoiDungGiayMoiPhoiHopDaChiDaoActivity extends BaseActivity<NoiDungGiayMoiPhoiHopDaChiDaoPresenter> implements NoiDungGiayMoiPhoiHopDaChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.activity_noi_dung_giay_moi_phoi_hop_da_chi_dao;
    }
    ...
    public void initializeComponents() {
        ...
        if (gmGiaoPhongPhoiHopDaChiDao != null) {
            ...
            idvb = gmGiaoPhongPhoiHopDaChiDao.getId();
            idPhoPhong = gmGiaoPhongPhoiHopDaChiDao.getIdPhoPhong();
            idcChuyenVienPhoiHop = gmGiaoPhongPhoiHopDaChiDao.getIdChuyenVienPhoiHops();
            ...
            tvTrichYeuNDVBDSVBDenChoLDXL.setText(String.valueOf(gmGiaoPhongPhoiHopDaChiDao.getMoTa()));
            tvChuyenPhoPhong.setText(String.valueOf(gmGiaoPhongPhoiHopDaChiDao.getTenPhoPhong()));
            tvNgayThangNamNDVBDSVBDenChoLDXL.setText(String.valueOf(gmGiaoPhongPhoiHopDaChiDao.getHanGiaiQuyet()));
            tvChiDao1NDVBDSVBDenChoLDXL.setText(String.valueOf(gmGiaoPhongPhoiHopDaChiDao.getChiDao()));
            tvChiDao2NDVBDSVBDenChoLDXL.setText(String.valueOf(gmGiaoPhongPhoiHopDaChiDao.getChiDaoChuTri()));
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NoiDungGiayMoiPhoiHopDaChiDaoActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvDuyetNDVBDSVBDenChoLDXL:
                ...
                getPresenter().duyetGMGiaoPhongPhoiHopDaChiDao(idvb, idPhoPhong, "", idcChuyenVienPhoiHop,
                        tvChiDao1NDVBDSVBDenChoLDXL.getText().toString(), tvChiDao2NDVBDSVBDenChoLDXL.getText().toString(),
                        tvNgayThangNamNDVBDSVBDenChoLDXL.getText().toString());
                break;
            case R.id.btnTuChoi:
                ...
                btnChuyenChanhVanBan.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        getPresenter().tuChoiGMPhoiHopDaChiDao(idPhoiHop, edtNoiDungTuChoi.getText().toString());
                    }
                });
                dialog.show();
                break;
    ...
    @Override
    public NoiDungGiayMoiPhoiHopDaChiDaoPresenter createPresenter() {
        return new NoiDungGiayMoiPhoiHopDaChiDaoPresenterImpl(this);
    }
