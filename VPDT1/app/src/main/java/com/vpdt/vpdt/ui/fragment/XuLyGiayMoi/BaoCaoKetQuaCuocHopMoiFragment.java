...
public class BaoCaoKetQuaCuocHopMoiFragment extends BaseFragment<BaoCaoKetQuaCuocHop_Presenter> implements BaoCaoKetQuaCuocHopView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_bao_cao_ket_qua_cuoc_hop_moi;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getallbaocaokequacuochopmoi(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getallbaocaokequacuochopmoi(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countbaocaokequacuochopmoi(NamLamViec);
    ...
    @OnClick({R.id.btnNamLamViec, R.id.btnBack, R.id.vkqchm, R.id.lnkqchm, R.id.rlkqchm, R.id.btnHome})
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getallbaocaokequacuochopmoi(String.valueOf(integer), true);
