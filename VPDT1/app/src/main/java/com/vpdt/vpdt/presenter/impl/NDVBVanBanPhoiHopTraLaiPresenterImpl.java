...
public class NDVBVanBanPhoiHopTraLaiPresenterImpl extends BasePresenterImpl<NDVBVanBanPhoiHopTraLaiView> implements NDVBVanBanPhoiHopTraLaiPresenter {

    public NDVBVanBanPhoiHopTraLaiPresenterImpl(NDVBVanBanPhoiHopTraLaiView view) {
        super(view);
    }
    ...
    @Override
    public void duyetVBPhoiHopTraLai(int id, int idPhoPhong, String idPhoPhongPhoiHops, String idChuyenVienPhoiHops, String chiDao, String chiDaoChuTri, String hanGiaiQuyet, int idCanBoTuchoi) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetVBPhoiHopTraLai(token, id, idPhoPhong, idPhoPhongPhoiHops, idChuyenVienPhoiHops, chiDao, chiDaoChuTri,
