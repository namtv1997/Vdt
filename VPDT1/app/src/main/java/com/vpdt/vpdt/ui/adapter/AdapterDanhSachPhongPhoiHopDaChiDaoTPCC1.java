...
public class AdapterDanhSachPhongPhoiHopDaChiDaoTPCC1 extends RecyclerView.Adapter<AdapterDanhSachPhongPhoiHopDaChiDaoTPCC1.ViewHolder> {
    private ArrayList<ItemDanhSachPhongPhoiHopDaChiDaoTPCC> itemArrayList;
    OnItemClickListener listener;


    public AdapterDanhSachPhongPhoiHopDaChiDaoTPCC1(ArrayList<ItemDanhSachPhongPhoiHopDaChiDaoTPCC> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDanhSachPhongPhoiHopDaChiDaoTPCC giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDanhSachPhongPhoiHopDaChiDaoTPCC itemDanhSachPhongPhoiHopDaChiDaoTPCC);

        void onItemClickXuLy(ItemDanhSachPhongPhoiHopDaChiDaoTPCC itemDanhSachPhongPhoiHopDaChiDaoTPCC);

        void onItemClickXemChiTiet(ItemDanhSachPhongPhoiHopDaChiDaoTPCC itemDanhSachPhongPhoiHopDaChiDaoTPCC);
    }
}
