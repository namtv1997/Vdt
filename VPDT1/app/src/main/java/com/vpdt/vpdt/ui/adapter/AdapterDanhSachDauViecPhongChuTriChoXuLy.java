...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NoiDungDauViecPhongChuTriChoXuLyPhoPhongPhoiHopActivity;
...
public class AdapterDanhSachDauViecPhongChuTriChoXuLy extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongChuTriChoXuLy.ViewHolder> implements AdapterDauViecPhongChuTriChoXuLy.OnItemClickListener {
    ...
    public AdapterDanhSachDauViecPhongChuTriChoXuLy(Context context, ArrayList<DanhSachDauViecPhongChuTriChoXuLy> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong) {
        if (level == 7) {
            Intent intent = new Intent(context, NoiDungDauViecPhongChuTriChoXuLyPhoPhongPhoiHopActivity.class);
