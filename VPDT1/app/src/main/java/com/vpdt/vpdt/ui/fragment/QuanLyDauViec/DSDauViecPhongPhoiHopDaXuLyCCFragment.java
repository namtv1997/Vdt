...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecPhongPhoiHopDaXuLyCC;
...
public class DSDauViecPhongPhoiHopDaXuLyCCFragment extends BaseFragment<DauViecPhongChuTriChoXuLyCCPresenter> implements DauViecPhongChuTriChoXuLyCCView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDauViecPhongPhoiHopDaXuLyCC.OnItemXemFileClickListener {
    ...
    AdapterDauViecPhongPhoiHopDaXuLyCC adapterDanhSachDauViecQuaHanCuaPhong;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_ds_dau_viec_phong_phoi_hop_da_xu_ly_cc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongPhoHopDaXuLyCC(NamLamViec, true);
    ...
    public void onGetPhoiHopSuccess(ArrayList<DauViecPhongPhoiHopChoXuLyCC> dauViecPhongPhoiHopChoXuLyCCArrayList) {
        adapterDanhSachDauViecQuaHanCuaPhong = new AdapterDauViecPhongPhoiHopDaXuLyCC(getActivity(), dauViecPhongPhoiHopChoXuLyCCArrayList, this);
