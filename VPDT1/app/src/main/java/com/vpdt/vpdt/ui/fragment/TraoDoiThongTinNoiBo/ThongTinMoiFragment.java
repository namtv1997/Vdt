...
import com.vpdt.vpdt.ui.activity.TraoDoiThongTinNoiBo.TTVBThongTinMoiActivity;
...
public class ThongTinMoiFragment extends BaseFragment<ThongTinMoiPresenter> implements ThongTinMoiView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_thong_tin_moi;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getallvanbanThongTinNoiBo(NamLamViec, 1, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getallvanbanThongTinNoiBo(NamLamViec, 1, false);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getallvanbanThongTinNoiBo(String.valueOf(integer), 1, true);
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countvanbanThongTinNoiBo(NamLamViec, 1);
    ...
    public void onItemClickXemChiTiet(TraoDoiThongTinNoiBo traoDoiThongTinNoiBo) {
        if (!click) {
            Intent intent1 = new Intent(getActivity(), TTVBThongTinMoiActivity.class);
            intent1.putExtra("ThongTinMoi", traoDoiThongTinNoiBo.getId());
