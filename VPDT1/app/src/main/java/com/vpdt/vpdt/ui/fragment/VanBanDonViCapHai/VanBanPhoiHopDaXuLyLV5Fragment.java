...
public class VanBanPhoiHopDaXuLyLV5Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV5Presenter> implements VanBanChoXuLyVBChuTriLV5View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_phoi_hop_da_xu_ly_lv4;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBPhoiHopDaXuLyCVDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBPhoiHopDaXuLyCVDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBPhoiHopDaXuLyCVDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBPhoiHopDaXuLyCVDonViCapHai(String.valueOf(integer), true);
