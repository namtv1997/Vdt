...
public class AdapterVanBanCacPhongChuyenLai extends RecyclerView.Adapter<AdapterVanBanCacPhongChuyenLai.ViewHolder> {
    private ArrayList<VanBanCacPhongChuyenLai> xemDeBietArrayList;
    private OnItemClickListenerXemDeBiet listener;


    public AdapterVanBanCacPhongChuyenLai(ArrayList<VanBanCacPhongChuyenLai> xemDeBietArrayList, OnItemClickListenerXemDeBiet listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanCacPhongChuyenLai dsvb_daChiDao = xemDeBietArrayList.get(position);
...
//        if (dsvb_daChiDao.get().isEmpty() || dsvb_daChiDao.getlo() == null) {
...
//        if (dsvb_daChiDao.getNgayNhap().isEmpty() || dsvb_daChiDao.getNgayNhap() == null) {
        viewHolder.tvNguoiNhap.setVisibility(View.GONE);
//        } else {
//            viewHolder.tvNguoiNhap.setText(String.valueOf("Ngày nhập: " + dsvb_daChiDao.getn()));
//        }
    ...
    public interface OnItemClickListenerXemDeBiet {
        void onItemClickXemFile(VanBanCacPhongChuyenLai vanBanCacPhongChuyenLai);

        void onItemClickXuLy(VanBanCacPhongChuyenLai vanBanCacPhongChuyenLai);

        void onItemClickXemChiTiet(VanBanCacPhongChuyenLai vanBanCacPhongChuyenLai);
    }
}
