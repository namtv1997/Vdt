...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecPhongChuTriChoXuLyTPCC;
...
public class DauViecPhongChuTriChoXuLyTPCCFragment extends BaseFragment<DauViecPhongChuTriChoXuLyTPCCPresenter> implements DauViecPhongChuTriChoXuLyTPCCView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDauViecPhongChuTriChoXuLyTPCC.OnItemXemFileClickListener {
    ...
    AdapterDauViecPhongChuTriChoXuLyTPCC adapterDanhSachDauViecQuaHanCuaPhong;
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongChuTriChoXuLyTPCC(NamLamViec);
    ...
    public void onGetSuccess(ArrayList<DauViecPhongChuTriChoXuLyTPCC> dauViecPhongChuTriChoXuLyTPCCArrayList) {
        adapterDanhSachDauViecQuaHanCuaPhong = new AdapterDauViecPhongChuTriChoXuLyTPCC(getActivity(), dauViecPhongChuTriChoXuLyTPCCArrayList, this);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongChuTriChoXuLyTPCC(String.valueOf(integer));
