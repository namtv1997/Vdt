...
import com.vpdt.vpdt.ui.activity.VanBanDi.NDVBDSGiayMoiCuaSoActivity;
import com.vpdt.vpdt.ui.activity.VanBanDi.TTVBVanBanXemDeBietActivity;
import com.vpdt.vpdt.ui.adapter.AdapterDanhSachGiayMoiCuaSo;
...
public class DanhSachGiayMoiCuaSoFragment extends BaseFragment<DanhSachVanBanCuaSoPresenter> implements DanhSachVanBanCuaSoView,
        AdapterDanhSachGiayMoiCuaSo.OnItemClickListener, AdapterNamLamViec.OnItemClickListenerNamLamViec {
    ...
    String NamLamViec;
    AdapterDanhSachGiayMoiCuaSo adapterDanhSachGiayMoiCuaSo;
    ...
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_giay_moi_cua_so;
    }
    ...
    public void onStart() {
        ...
        if (TenVB.getText().toString().equals("Văn bản đã nhập")) {
            getPresenter().getallvbditongthe(0, 1, NamLamViec, true);
        } else if (TenVB.getText().toString().equals("Đã gửi mail")) {
            getPresenter().getallvbditongthe(1, 1, NamLamViec, true);
        } else if (TenVB.getText().toString().equals("Chưa gửi mail")) {
            getPresenter().getallvbditongthe(2, 1, NamLamViec, true);
        }
        adapterDanhSachGiayMoiCuaSo = new AdapterDanhSachGiayMoiCuaSo(getContext(), getPresenter().detailVanBanDiTongTheArrayList(), this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerview.setLayoutManager(layoutManager);
        recyclerview.setAdapter(adapterDanhSachGiayMoiCuaSo);
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            @Override
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (TenVB.getText().toString().equals("Văn bản đã nhập")) {
                    getPresenter().getallvbditongthe(0, 1, NamLamViec, false);
                } else if (TenVB.getText().toString().equals("Đã gửi mail")) {
                    getPresenter().getallvbditongthe(1, 1, NamLamViec, false);
                } else if (TenVB.getText().toString().equals("Chưa gửi mail")) {
                    getPresenter().getallvbditongthe(2, 1, NamLamViec, false);
                }
            }
        };
    ...
    public void onGetDataSuccess() {
        adapterDanhSachGiayMoiCuaSo.notifyDataSetChanged();
        swipe_layout.setRefreshing(false);
        if (TenVB.getText().toString().equals("Văn bản đã nhập")) {
            getPresenter().countvbditongthe(1, 0, NamLamViec);
        } else if (TenVB.getText().toString().equals("Đã gửi mail")) {
            getPresenter().countvbditongthe(1, 1, NamLamViec);
        } else if (TenVB.getText().toString().equals("Chưa gửi mail")) {
            getPresenter().countvbditongthe(1, 2, NamLamViec);
        }
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        if (TenVB.getText().toString().equals("Văn bản đã nhập")) {
            getPresenter().getallvbditongthe(0, 1, String.valueOf(integer), true);
        } else if (TenVB.getText().toString().equals("Đã gửi mail")) {
            getPresenter().getallvbditongthe(1, 1, String.valueOf(integer), true);
        } else if (TenVB.getText().toString().equals("Chưa gửi mail")) {
            getPresenter().getallvbditongthe(2, 1, String.valueOf(integer), true);
        }
    ...
    public void onItemClickXuLy(DetailVanBanDiTongThe detailVanBanDiTongThe) {
        if (!click) {
            Intent i = new Intent(getContext(), NDVBDSGiayMoiCuaSoActivity.class);
