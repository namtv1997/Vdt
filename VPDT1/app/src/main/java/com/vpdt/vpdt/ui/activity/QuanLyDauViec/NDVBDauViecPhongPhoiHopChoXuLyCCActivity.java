...
public class NDVBDauViecPhongPhoiHopChoXuLyCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyCCView,
        DatePickerDialog.OnDateSetListener, AdapterChonPhoiHopPhongChuTri.OnItemClickListenerPhoPhongPhoiHop {
    ...
    String idPhongPhoiHop, tenPhongPhoiHop;
    boolean click = false;
    int id;

    @Override
    public int getContentViewId() {
        return R.layout.activity_ndvb_dau_viec_phong_phoi_hop_cho_xu_ly_cc;
    }
    ...
    public void initializeComponents() {
        ...
        ItemDauViecPhongPhoiHopChoXuLyCC itemDanhSachDauViecQuaHanCuaPhong = getIntent().getParcelableExtra("itemDauViecPhongChuTriChoXuLyCC");
    ...
    @OnClick({R.id.btnBack, R.id.tvXemChiTiet, R.id.lnNoiDungVB, R.id.btnChonPhoiHop, R.id.tvNgayThangNam, R.id.btnDuyet})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnChonPhoiHop:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongPhoHopChoXuLyCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), id, idPhongPhoiHop, tenPhongPhoiHop, tvNgayThangNam.getText().toString());
                break;
