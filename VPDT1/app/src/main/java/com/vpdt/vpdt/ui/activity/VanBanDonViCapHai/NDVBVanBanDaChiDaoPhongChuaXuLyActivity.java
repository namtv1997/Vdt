...
public class NDVBVanBanDaChiDaoPhongChuaXuLyActivity extends BaseActivity<NDVBVanBanChoChiDaoPresenter> implements NDVBVanBanChoChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_da_chi_dao_phong_chua_xu_ly;
    }
    ...
    public void initializeComponents() {
        ...
        VanBanDaChiDaoPhongChuaXuLy vanBanPhoiHopDaChiDao = getIntent().getParcelableExtra("vanBanChoChiDao");
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanDaChiDaoPhongChuaXuLyActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBDaChiDaoPhongChuaXuLyDonViCapHai(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
