...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecPhongPhoiHopChoXuLyCCActivity;
...
public class AdapterDauViecPhongPhoiHopChoXuLyCC extends RecyclerView.Adapter<AdapterDauViecPhongPhoiHopChoXuLyCC.ViewHolder> implements AdapterDauViecPhongPhoiHopChoXuLyCC1.OnItemClickListener {
    private ArrayList<DauViecPhongPhoiHopChoXuLyCC> baoCaoTongHopArrayList;
    OnItemXemFileClickListener listener;
    private RecyclerView.RecycledViewPool viewPool = new RecyclerView.RecycledViewPool();
    Context context;

    public AdapterDauViecPhongPhoiHopChoXuLyCC(Context context, ArrayList<DauViecPhongPhoiHopChoXuLyCC> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongPhoiHopChoXuLyCC itemDauViecPhongPhoiHopChoXuLyCC) {
        Intent intent = new Intent(context, NDVBDauViecPhongPhoiHopChoXuLyCCActivity.class);
