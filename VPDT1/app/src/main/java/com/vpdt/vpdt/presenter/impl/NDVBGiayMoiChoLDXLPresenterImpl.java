...
public class NDVBGiayMoiChoLDXLPresenterImpl extends BasePresenterImpl<NDVBGiayMoiChoLDXLView> implements NDVBGiayMoiChoLDXLPresenter {
    public NDVBGiayMoiChoLDXLPresenterImpl(NDVBGiayMoiChoLDXLView view) {
        super(view);
    }

    @Override
    public void getgiaymoicholanhdaoxulybyid(int id_giaymoi) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().getgiaymoicholanhdaoxulybyid(token, id_giaymoi, uid, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
    ...
    @Override
    public void duyetgiaymoicholanhdaoxuly(int id_giaymoi, int id_phogiamdoc, int id_phongchutri,
        ...
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetgiaymoicholanhdaoxuly(token, uid, id_giaymoi, id_phogiamdoc, id_phongchutri,
                ...
                .subscribe(new Subscriber<Response<Boolean>>() {
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        ...
                        if (booleanResponse.getData()) {
                            getView().duyetgiaymoicholanhdaoxulySucsess();
                        } else {
