...
public class AdapterGiayMoiChuTriChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiChuTriChoXuLy.ViewHolder> {
    private ArrayList<GiayMoiChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiChuTriChoXuLy(ArrayList<GiayMoiChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiChuTriChoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
        ...
        viewHolder.tvTieuDeNoiDung.setText(String.valueOf("*Nội dung chỉ đạo của đ/c " + giaHanGiaiQuyet.getTenChiDao() + ":"));
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiChuTriChoXuLy giayMoiChuTriChoXuLy);

        void onItemClickXuLy(GiayMoiChuTriChoXuLy giayMoiChuTriChoXuLy);

        void onItemClickXemChiTiet(GiayMoiChuTriChoXuLy giayMoiChuTriChoXuLy);
    }
}
