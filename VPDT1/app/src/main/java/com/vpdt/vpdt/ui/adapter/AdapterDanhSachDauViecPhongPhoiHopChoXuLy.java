...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecPhongPhoiHopChoXuLyActivity;
...
public class AdapterDanhSachDauViecPhongPhoiHopChoXuLy extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongPhoiHopChoXuLy.ViewHolder> implements AdapterDauViecPhongChuTriChoXuLy.OnItemClickListener {
    ...
    public AdapterDanhSachDauViecPhongPhoiHopChoXuLy(Context context, ArrayList<DanhSachDauViecPhongChuTriChoXuLy> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong) {
        Intent intent = new Intent(context, NDVBDauViecPhongPhoiHopChoXuLyActivity.class);
