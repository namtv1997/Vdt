...
public class NDVBVBSTCPhoiHopDaChiDaoPresenterImpl extends BasePresenterImpl<NDVBVBSTCPhoiHopDaChiDaoView> implements NDVBVBSTCPhoiHopDaChiDaoPresenter {
    public NDVBVBSTCPhoiHopDaChiDaoPresenterImpl(NDVBVBSTCPhoiHopDaChiDaoView view) {
        super(view);
    }
    ...
    @Override
    public void duyetVBSTCPhoiHopDaChiDaoPhong(int id, int idPhoPhong, String idPhoPhongPhoiHops, int idChuyenVien,
                                               String idChuyenVienPhoiHops, String chiDao, String chiDaoChuTri, String vanBanDauRaTruongPhong, boolean vanBanQuanTrong, boolean phoGiamDocDonDoc, String hanGiaiQuyet) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetVBSTCPhoiHopDaChiDaoPhong(token, id, idPhoPhong, idPhoPhongPhoiHops, idChuyenVien, idChuyenVienPhoiHops, chiDao, chiDaoChuTri, vanBanDauRaTruongPhong,
