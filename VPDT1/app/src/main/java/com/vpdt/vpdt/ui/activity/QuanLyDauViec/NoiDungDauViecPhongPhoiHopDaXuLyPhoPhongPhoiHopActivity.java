...
import com.vpdt.vpdt.presenter.NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopPresenter;
import com.vpdt.vpdt.presenter.NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopView;
import com.vpdt.vpdt.presenter.impl.NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopPresenterImpl;
...
public class NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopActivity extends BaseActivity<NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopPresenter> implements
        NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopView, DatePickerDialog.OnDateSetListener,
    ...
    public int getContentViewId() {
        return R.layout.activity_noi_dung_dau_viec_phong_phoi_hop_da_xu_ly_pho_phong_phoi_hop;
    }
    ...
    public void initializeComponents() {
        ...
        ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh itemDanhSachDauViecQuaHanCuaPhong = getIntent().getParcelableExtra("itemDauViecPhongChuTriDaChiDaoChuaHoanThanh");
        if (itemDanhSachDauViecQuaHanCuaPhong != null) {
            ...
            tenChuyenvienPhoiHop = itemDanhSachDauViecQuaHanCuaPhong.getTenChuyenVienPhoiHops();
            ...
            edtChiDao1.setText(String.valueOf(itemDanhSachDauViecQuaHanCuaPhong.getTenChuyenVienPhoiHops()));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnNoiDungVB:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongPhoHopDaChiDaoTPPH(id, idChuyenVienPhoiHops, tenChuyenvienPhoiHop, tvNgayThangNam.getText().toString());
                break;
    ...
    @Override
    public NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopPresenter createPresenter() {
        return new NoiDungDauViecPhongPhoiHopDaXuLyPhoPhongPhoiHopPresenterImpl(this);
    }
}
