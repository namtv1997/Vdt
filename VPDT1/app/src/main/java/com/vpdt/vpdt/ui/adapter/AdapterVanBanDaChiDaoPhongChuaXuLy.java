...
public class AdapterVanBanDaChiDaoPhongChuaXuLy extends RecyclerView.Adapter<AdapterVanBanDaChiDaoPhongChuaXuLy.ViewHolder> {
    private ArrayList<VanBanDaChiDaoPhongChuaXuLy> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanDaChiDaoPhongChuaXuLy(ArrayList<VanBanDaChiDaoPhongChuaXuLy> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanDaChiDaoPhongChuaXuLy giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanDaChiDaoPhongChuaXuLy vanBanChoChiDao);

        void onItemClickXuLy(VanBanDaChiDaoPhongChuaXuLy vanBanChoChiDao);

        void onItemClickXemChiTiet(VanBanDaChiDaoPhongChuaXuLy vanBanChoChiDao);
    }
}
