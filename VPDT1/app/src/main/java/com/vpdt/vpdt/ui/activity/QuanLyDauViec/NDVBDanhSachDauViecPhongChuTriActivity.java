...
public class NDVBDanhSachDauViecPhongChuTriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ndvbdanh_sach_dau_viec_phong_chu_tri);
        ButterKnife.bind(this);
        Util.checkConnection(this);
        ItemDauViec itemDauViec = getIntent().getParcelableExtra("itemDauViecChuTri");
        if (itemDauViec != null) {
