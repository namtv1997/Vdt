...
public class DanhSachVanBanPhongPhoiHopLV3Fragment extends BaseFragment<DanhSachVanBanPhongChuTriLV3Presenter> implements DanhSachVanBanPhongChuTriLV3View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_van_ban_phong_phoi_hop_lv3;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBDonViCapHai(NamLamViec, 2, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBDonViCapHai(NamLamViec, 2, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBDonViCapHai(NamLamViec, 2);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBDonViCapHai(String.valueOf(integer), 2, true);
