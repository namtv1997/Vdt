...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NDVBDauViecPhongPhoiHopDaChiDaoChuaHTActivity;
...
public class AdapterDanhSachDauViecPhongPhoiHopDaChiDaoChuaHT extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongPhoiHopDaChiDaoChuaHT.ViewHolder> implements AdapterDauViecPhongChuTriDaChiDaoChuaHT.OnItemClickListener {
    ...
    public AdapterDanhSachDauViecPhongPhoiHopDaChiDaoChuaHT(Context context, ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriDaChiDaoChuaHoanThanh itemDauViecPhongChuTriDaChiDaoChuaHoanThanh) {
        if (level == 7) {
            ...
            Intent intent = new Intent(context, NDVBDauViecPhongPhoiHopDaChiDaoChuaHTActivity.class);
            intent.putExtra("itemDauViecPhongChuTriDaChiDaoChuaHoanThanh", itemDauViecPhongChuTriDaChiDaoChuaHoanThanh);
            context.startActivity(intent);
        }
    }
