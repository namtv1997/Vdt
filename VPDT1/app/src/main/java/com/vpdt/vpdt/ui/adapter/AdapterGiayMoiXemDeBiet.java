...
public class AdapterGiayMoiXemDeBiet extends RecyclerView.Adapter<AdapterGiayMoiXemDeBiet.ViewHolder> {
    private ArrayList<GiayMoiXemDeBiet> giayMoiXemDeBietArrayList;
    private OnItemClickListenerXemDeBiet listener;


    public AdapterGiayMoiXemDeBiet(ArrayList<GiayMoiXemDeBiet> giayMoiXemDeBietArrayList, OnItemClickListenerXemDeBiet listener) {
        this.giayMoiXemDeBietArrayList = giayMoiXemDeBietArrayList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiXemDeBiet dsvb_daChiDao = giayMoiXemDeBietArrayList.get(position);
        ...
        viewHolder.tvLoaiVanBan.setText(String.valueOf("Thuộc loại: " + dsvb_daChiDao.getThuocLoai()));
        if (dsvb_daChiDao.getThuocLoai() == null) {
            viewHolder.tvLoaiVanBan.setVisibility(View.GONE);
        } else {
            if (dsvb_daChiDao.getThuocLoai().isEmpty()) {
                viewHolder.tvLoaiVanBan.setVisibility(View.GONE);
            } else {
...
//        if (dsvb_daChiDao.gets().isEmpty() || dsvb_daChiDao.getSoTrang() == null) {
        ...
        if (dsvb_daChiDao.getGiayMoiGio() == null) {
            viewHolder.tvSoTrang.setVisibility(View.GONE);
        } else {
            if (dsvb_daChiDao.getGiayMoiGio().isEmpty()) {
                viewHolder.tvSoTrang.setVisibility(View.GONE);
            } else {
...
//        }
        ...
        viewHolder.btnXemFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (giayMoiXemDeBietArrayList.size() > 0) {
                        listener.onItemClickXemFile(giayMoiXemDeBietArrayList.get(position));
                    }
                }
            }
        });
        viewHolder.btnXuLy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (giayMoiXemDeBietArrayList.size() > 0) {
                        listener.onItemClickXuLy(giayMoiXemDeBietArrayList.get(position));
                    }
                }
            }
        });
        viewHolder.btnXemChiTiet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (giayMoiXemDeBietArrayList.size() > 0) {
                        listener.onItemClickXemChiTiet(giayMoiXemDeBietArrayList.get(position));
                    }
                }
            }
        });
    ...
    public int getItemCount() {
        return giayMoiXemDeBietArrayList.size();
    }
    ...
    public interface OnItemClickListenerXemDeBiet {
        void onItemClickXemFile(GiayMoiXemDeBiet giayMoiXemDeBiet);

        void onItemClickXuLy(GiayMoiXemDeBiet giayMoiXemDeBiet);

        void onItemClickXemChiTiet(GiayMoiXemDeBiet giayMoiXemDeBiet);
    }
}
