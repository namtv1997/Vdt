...
public class NDVBDSDauViecPhongChuTriDaXuLyCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyCCView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdsdau_viec_phong_chu_tri_da_xu_ly_cc;
    }
    ...
    public void initializeComponents() {
        ...
        ItemDSDauViecPhongChuTriDaXuLyCC itemDanhSachDauViecQuaHanCuaPhong = getIntent().getParcelableExtra("itemDauViecPhongChuTriChoXuLyCC");
        if (itemDanhSachDauViecQuaHanCuaPhong != null) {
            ...
            if (itemDanhSachDauViecQuaHanCuaPhong.getAllowDuyet().equals("true")) {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvChonPhongChuTri:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongChuTriDaXuLyCC(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""), id, idPhongBan, tenPhongBan, idPhongPhoiHop, tenPhongPhoiHop, tvNgayThangNam.getText().toString());
                break;
