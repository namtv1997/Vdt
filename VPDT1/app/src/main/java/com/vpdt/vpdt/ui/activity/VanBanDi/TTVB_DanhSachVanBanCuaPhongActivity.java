...
public class TTVB_DanhSachVanBanCuaPhongActivity extends BaseActivity<TTVBVanBanTrinhKyPresenter> implements TTVBVanBanTrinhKyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvb_danh_sach_van_ban_cua_phong;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("dsvbCuaPhong")) {
                idvb = intent.getIntExtra("dsvbCuaPhong", 0);
