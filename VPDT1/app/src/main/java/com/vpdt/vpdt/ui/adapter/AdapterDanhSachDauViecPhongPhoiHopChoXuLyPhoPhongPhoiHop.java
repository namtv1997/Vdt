...
import com.vpdt.vpdt.ui.activity.QuanLyDauViec.NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopActivity;
...
public class AdapterDanhSachDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHop extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHop.ViewHolder> implements AdapterDauViecPhongChuTriChoXuLy.OnItemClickListener {
    ...
    public AdapterDanhSachDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHop(Context context, ArrayList<DanhSachDauViecPhongChuTriChoXuLy> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
    ...
    public void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong) {
        Intent intent = new Intent(context, NoiDungDauViecPhongPhoiHopChoXuLyPhoPhongPhoiHopActivity.class);
    ...
    public void onItemClickXemChiTiet(ItemDauViecPhongChuTriChoXuLy itemDanhSachDauViecQuaHanCuaPhong) {
        ...
        intent.putExtra("idvb", itemDanhSachDauViecQuaHanCuaPhong.getId());
        context.startActivity(intent);
    }
