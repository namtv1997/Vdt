...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecPhongPhoiHopChoXuLyTPCC;
...
public class DauViecPhongPhoiHopChoXuLyTPCCFragment extends BaseFragment<DauViecPhongChuTriChoXuLyTPCCPresenter> implements DauViecPhongChuTriChoXuLyTPCCView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDauViecPhongPhoiHopChoXuLyTPCC.OnItemXemFileClickListener {
    ...
    AdapterDauViecPhongPhoiHopChoXuLyTPCC adapterDanhSachDauViecQuaHanCuaPhong;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_phong_phoi_hop_cho_xu_ly_tpcc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongPhoHopChoXuLyTPCC(NamLamViec);
    ...
    public void onGetSuccess(ArrayList<DauViecPhongChuTriChoXuLyTPCC> dauViecPhongChuTriChoXuLyTPCCArrayList) {
        adapterDanhSachDauViecQuaHanCuaPhong = new AdapterDauViecPhongPhoiHopChoXuLyTPCC(getActivity(), dauViecPhongChuTriChoXuLyTPCCArrayList, this);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongPhoHopChoXuLyTPCC(String.valueOf(integer));
