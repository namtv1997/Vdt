...
public class GiayMoiPhoiHopDaXuLy implements Parcelable {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    protected GiayMoiPhoiHopDaXuLy(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
    ...
    public static final Creator<GiayMoiPhoiHopDaXuLy> CREATOR = new Creator<GiayMoiPhoiHopDaXuLy>() {
        @Override
        public GiayMoiPhoiHopDaXuLy createFromParcel(Parcel in) {
            return new GiayMoiPhoiHopDaXuLy(in);
        }

        @Override
        public GiayMoiPhoiHopDaXuLy[] newArray(int size) {
            return new GiayMoiPhoiHopDaXuLy[size];
        }
    };
