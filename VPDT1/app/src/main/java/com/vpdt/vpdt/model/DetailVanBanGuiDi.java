...
public class DetailVanBanGuiDi {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @SerializedName("don_vi_can_nhan_vanbans")
    @Expose
    private List<DonViCanNhanVanban> donViCanNhanVanbans = null;
    ...
    public List<DonViCanNhanVanban> getDonViCanNhanVanbans() {
        return donViCanNhanVanbans;
    }

    public void setDonViCanNhanVanbans(List<DonViCanNhanVanban> donViCanNhanVanbans) {
        this.donViCanNhanVanbans = donViCanNhanVanbans;
    }
