...
public class NoiDungVanBanDaPhanLoaiPresenterImpl extends BasePresenterImpl<NoiDungVanBanDaPhanLoaiView> implements NoiDungVanBanDaPhanLoaiPresenter {
    public NoiDungVanBanDaPhanLoaiPresenterImpl(NoiDungVanBanDaPhanLoaiView view) {
        super(view);
    }
    ...
    @Override
    public void duyetVanBanDaPhanLoai(int id, int idGiamDoc, int idPhoGiamDoc, int idPhongChuTri, String hanGiaiQuyet, String idPhongPhoiHop, String chiDaoGiamDoc, String chiDaoPhoGiamDoc, String chiChuTri, int isVBQT) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetVanBanDaPhanLoai(token, id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hanGiaiQuyet, idPhongPhoiHop, chiDaoGiamDoc, chiDaoPhoGiamDoc, chiChuTri, isVBQT,
                ...
                .subscribe(new Subscriber<Response<Boolean>>() {
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        ...
                        if (booleanResponse.getData()) {
                            getView().duyetVanBanDaPhanLoaiSuccess();
                        } else {
