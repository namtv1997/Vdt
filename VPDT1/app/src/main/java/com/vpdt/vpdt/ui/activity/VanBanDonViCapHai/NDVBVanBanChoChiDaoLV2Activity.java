...
public class NDVBVanBanChoChiDaoLV2Activity extends BaseActivity<NDVBVanBanChoChiDaoPresenter> implements NDVBVanBanChoChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_cho_chi_dao_lv2;
    }
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanChoChiDaoLV2Activity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBChoChiDaoDonViCapHaiPhong(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
                        id, idPhongChuTri, tvPhong.getText().toString(),
