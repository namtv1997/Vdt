...
public class AdapterVanBanChoXuLyLV5 extends RecyclerView.Adapter<AdapterVanBanChoXuLyLV5.ViewHolder> {
    private ArrayList<VanBanChoXuLyLV5> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterVanBanChoXuLyLV5(ArrayList<VanBanChoXuLyLV5> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanChoXuLyLV5 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanChoXuLyLV5 vanBanChoXuLyLV5);

        void onItemClickXuLy(VanBanChoXuLyLV5 vanBanChoXuLyLV5);

        void onItemClickXemChiTiet(VanBanChoXuLyLV5 vanBanChoXuLyLV5);
    }
}
