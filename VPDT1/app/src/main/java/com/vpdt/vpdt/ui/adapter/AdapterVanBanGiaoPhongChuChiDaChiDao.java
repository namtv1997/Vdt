...
public class AdapterVanBanGiaoPhongChuChiDaChiDao extends RecyclerView.Adapter<AdapterVanBanGiaoPhongChuChiDaChiDao.ViewHolder> {

    private ArrayList<PhongChuTriDaChiDao> DSVB_DaChiDaoList;

    private OnItemClickListener listener;


    public AdapterVanBanGiaoPhongChuChiDaChiDao(ArrayList<PhongChuTriDaChiDao> DSVB_DaChiDaoList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        PhongChuTriDaChiDao dsvb_daChiDao = DSVB_DaChiDaoList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(PhongChuTriDaChiDao phongChuTriDaChiDao);

        void onItemClickXuLy(PhongChuTriDaChiDao phongChuTriDaChiDao);

        void onItemClickXemChiTiet(PhongChuTriDaChiDao phongChuTriDaChiDao);
    }
}
