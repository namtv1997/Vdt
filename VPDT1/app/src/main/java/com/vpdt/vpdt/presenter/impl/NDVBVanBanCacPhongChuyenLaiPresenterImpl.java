...
public class NDVBVanBanCacPhongChuyenLaiPresenterImpl extends BasePresenterImpl<NDVBVanBanCacPhongChuyenLaiView> implements NDVBVanBanCacPhongChuyenLaiPresenter {
    public NDVBVanBanCacPhongChuyenLaiPresenterImpl(NDVBVanBanCacPhongChuyenLaiView view) {
        super(view);
    }
    ...
    @Override
    public void duyetAllVanBanChuyenLai(int id, int idGiamDoc, int idPhoGiamDoc, int idPhongChuTri, String hanGiaiQuyet, String idPhongPhoiHop, String chiDaoGiamDoc, String chiDaoPhoGiamDoc, String chiChuTri, int isVBQT) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetAllVanBanChuyenLai(token, id, idGiamDoc, idPhoGiamDoc, idPhongChuTri, hanGiaiQuyet, idPhongPhoiHop, chiDaoGiamDoc, chiDaoPhoGiamDoc, chiChuTri, isVBQT, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        ...
                        if (booleanResponse.getData()) {
                            getView().duyetVBCTDChuaPhanLoai();
                        } else {
