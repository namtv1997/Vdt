...
public class AdapterTenGiamDoc extends RecyclerView.Adapter<AdapterTenGiamDoc.ViewHolder> {
    private ArrayList<GiamdocVaPhoGiamdoc> listTenGiamDoc;
    private Context mContext;
    private OnItemClickListener listener;

    public AdapterTenGiamDoc(Context context, ArrayList<GiamdocVaPhoGiamdoc> listTenGiamDoc, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onItemClick(listTenGiamDoc.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(GiamdocVaPhoGiamdoc giamdocVaPhoGiamdoc);
    }
}
