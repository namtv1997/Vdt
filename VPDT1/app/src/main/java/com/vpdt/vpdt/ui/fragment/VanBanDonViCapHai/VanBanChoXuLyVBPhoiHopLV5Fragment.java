...
public class VanBanChoXuLyVBPhoiHopLV5Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV5Presenter> implements VanBanChoXuLyVBChuTriLV5View,
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBChoXuLyCVPhoiHopDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBChoXuLyCVPhoiHopDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBChoXuLyCVPhoiHopDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBChoXuLyCVPhoiHopDonViCapHai(String.valueOf(integer), true);
