...
public class AdapterDauViecQuaHanCuaPhong extends RecyclerView.Adapter<AdapterDauViecQuaHanCuaPhong.ViewHolder> {
    private ArrayList<ItemDanhSachDauViecQuaHanCuaPhong> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecQuaHanCuaPhong(ArrayList<ItemDanhSachDauViecQuaHanCuaPhong> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDanhSachDauViecQuaHanCuaPhong giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDanhSachDauViecQuaHanCuaPhong itemDanhSachDauViecQuaHanCuaPhong);

        void onItemClickXuLy(ItemDanhSachDauViecQuaHanCuaPhong itemDanhSachDauViecQuaHanCuaPhong);

        void onItemClickXemChiTiet(ItemDanhSachDauViecQuaHanCuaPhong itemDanhSachDauViecQuaHanCuaPhong);
    }
}
