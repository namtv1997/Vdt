...
public class NDVBDSVBDenChoLDXLPresenterImpl extends BasePresenterImpl<NDVBDSVBDenChoLDXLView> implements NDVBDSVBDenChoLDXLPresenter {

    public NDVBDSVBDenChoLDXLPresenterImpl(NDVBDSVBDenChoLDXLView view) {
        super(view);
    }
...
//        Util.getIns().showLoadding(getView().gContext());
    ...
    @Override
    public void getbyidvbdenchoxuly(int id_vb) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().getbyidvbdenchoxuly(token, id_vb, uid, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<VanBanDenChoXuLy>>() {
                    @Override
                    public void onCompleted() {
                        // Util.getIns().hideLoadding();
                    }
                    ...
                    @Override
                    public void onNext(Response<VanBanDenChoXuLy> dsvb_dachidaoResponse) {
                        Util.getIns().hideLoadding();
    ...
    @Override
    public void chonDeLuuVanBan(int id_vb) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().chonDeLuuVanBan(token, id_vb, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        ...
                        if (booleanResponse.getData()) {
                            getView().onGetDuyetVanBandenchoxuly();
                        } else {
    ...
    @Override
    public void duyetvbdenchoxuly(int id_vb, int id_phogiamdoc, int id_phongchutri, String id_phong_phoihops, String chidao_phogiamdoc, String chidao_phongchutri, boolean phogiamdocthammuu, String han_giai_quyet, boolean is_vbquantrong) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().duyetvbdenchoxuly(token, uid, id_vb, id_phogiamdoc, id_phongchutri,
                id_phong_phoihops, chidao_phogiamdoc, chidao_phongchutri,
                phogiamdocthammuu, han_giai_quyet, is_vbquantrong, PrefUtil.getString(getView().gContext(), Key.NAM_LAM_VIEC, ""))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    @Override
    ...
    @Override
    public void themNoidungVBChuaPhanLoai(int id, String hanNoiDung, String noiDung, String nam) {
        Util.getIns().showLoadding(getView().gContext());
        String token = "Bearer " + PrefUtil.getToken(getView().gContext()).getAccessToken();
        String uid = PrefUtil.getToken(getView().gContext()).getUid();
        NetworkModule.getService().themNoidungVBChuaPhanLoai(token, id, hanNoiDung, noiDung, nam)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Subscriber<Response<Boolean>>() {
                    @Override
                    ...
                    public void onNext(Response<Boolean> booleanResponse) {
                        Util.getIns().hideLoadding();
                        if (booleanResponse.getData()) {
                            getView().onGetThemNoiDungSuccess();
                        } else {
                            Util.showMessenger(booleanResponse.getMessage(), getView().gContext());
                        }
                    }
