...
public class TTVBDanhSachGiayMoiCuaPhongActivity extends BaseActivity<TTVBVanBanTrinhKyPresenter> implements TTVBVanBanTrinhKyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbdanh_sach_giay_moi_cua_phong;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("dsGiayMoiCuaPhong")) {
                idvb = intent.getIntExtra("dsGiayMoiCuaPhong", 0);
