...
public class DanhSachDauViecDeXuatGiaHanDaXuLyFragment extends BaseFragment<DanhSachDauViecDeXuatGiaHanPresenter> implements DanhSachDauViecDeXuatGiaHanView,
    ...
    public void onStart() {
        ...
        getPresenter().getalldauviecdexuatgiahan(NamLamViec, 1, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getalldauviecdexuatgiahan(NamLamViec, 1, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().coutalldauviecdexuatgiahan(NamLamViec, 1);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getalldauviecdexuatgiahan(String.valueOf(integer), 1, true);
    ...
    public void onItemClickXemChiTiet(DauViecDeXuat dauViecDeXuat) {
        if (!click) {
            ...
            intent.putExtra("idvb", dauViecDeXuat.getId());
            startActivity(intent);
            click = true;
        }
