...
public class TTVB_DeXuatCongViecPhoiHopChoDuyetPresenterImpl extends BasePresenterImpl<TTVB_DeXuatCongViecPhoiHopChoDuyetView> implements TTVB_DeXuatCongViecPhoiHopChoDuyetPresenter {
    public TTVB_DeXuatCongViecPhoiHopChoDuyetPresenterImpl(TTVB_DeXuatCongViecPhoiHopChoDuyetView view) {
        super(view);
    }
