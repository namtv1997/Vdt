...
public class AdapterDSDauViecPhongChuTriDaXuLyCC1 extends RecyclerView.Adapter<AdapterDSDauViecPhongChuTriDaXuLyCC1.ViewHolder> {
    private ArrayList<ItemDSDauViecPhongChuTriDaXuLyCC> itemArrayList;
    OnItemClickListener listener;


    public AdapterDSDauViecPhongChuTriDaXuLyCC1(ArrayList<ItemDSDauViecPhongChuTriDaXuLyCC> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDSDauViecPhongChuTriDaXuLyCC giaHanGiaiQuyet = itemArrayList.get(position);
...
//        } else {
//            viewHolder.tvLoaiVanBan.setText(String.valueOf("Loại văn bản: " + giaHanGiaiQuyet.getHanXuLy()));
//        }
...
//        } else {
//            if (giaHanGiaiQuyet.getGiayMoiGio().isEmpty() || giaHanGiaiQuyet.getGiayMoiGio() == null) {
//                viewHolder.tvSoTrang.setText(String.valueOf("(Số trang: " + giaHanGiaiQuyet.get() + ")"));
//            } else {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDSDauViecPhongChuTriDaXuLyCC itemDSDauViecPhongChuTriDaXuLyCC);

        void onItemClickXuLy(ItemDSDauViecPhongChuTriDaXuLyCC itemDSDauViecPhongChuTriDaXuLyCC);

        void onItemClickXemChiTiet(ItemDSDauViecPhongChuTriDaXuLyCC itemDSDauViecPhongChuTriDaXuLyCC);
    }
}
