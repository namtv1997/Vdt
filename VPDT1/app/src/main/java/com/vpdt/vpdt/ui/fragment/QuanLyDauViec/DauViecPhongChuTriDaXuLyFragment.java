...
import com.vpdt.vpdt.ui.adapter.AdapterDanhSachDauViecPhongChuTriDaXuLy;
...
public class DauViecPhongChuTriDaXuLyFragment extends BaseFragment<DauViecPhongChuTriDaChiDaoChuaHTPresenter> implements DauViecPhongChuTriDaChiDaoChuaHTView,
        AdapterDanhSachDauViecPhongChuTriDaXuLy.OnItemXemFileClickListener,
    ...
    AdapterDanhSachDauViecPhongChuTriDaXuLy adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_phong_chu_tri_da_xu_ly;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongChuTriDaChiDao(NamLamViec, false);
    ...
    public void ongetAllDauViecPhongChuTriDaChiDaoSuccess(ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList) {
        adapterDanhSachDauViecPhongChuTriDaChiDaoChuaHT = new AdapterDanhSachDauViecPhongChuTriDaXuLy(getActivity(), danhSachDauViecPhongChuTriDaChiDaoChuaHTArrayList, this);
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongChuTriDaChiDao(String.valueOf(integer), false);
