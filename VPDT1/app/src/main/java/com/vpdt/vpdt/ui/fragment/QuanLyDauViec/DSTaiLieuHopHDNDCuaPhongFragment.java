...
public class DSTaiLieuHopHDNDCuaPhongFragment extends BaseFragment<DSKienNghiHDND_Presenter> implements DSKienNghiHDNDView,
        Adapter_QuanLyDauViec.OnItemClickListener,
        AdapterXemFile.OnItemClickListener, AdapterNamLamViec.OnItemClickListenerNamLamViec {
    ...
    public int getContentViewId() {
        return R.layout.fragment_ds_tai_lieu_hop_hdnd_cua_phong;
    }
    ...
    public void initializeComponents(View view) {
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getPresenter().getalltaileuhopphong(NamLamViec, true);
            }
        });
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            @Override
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getalltaileuhopphong(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countalltaileuhopphong(NamLamViec);
    ...
    @OnClick({R.id.btnNamLamViec, R.id.btnBack1, R.id.vDSTLHP, R.id.rlDSTLHP, R.id.lnDSTLHP, R.id.btnHome})
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getalltaileuhopphong(String.valueOf(integer), true);
