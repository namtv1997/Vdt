...
public class AdapterDauViecPhongChuTriChoXuLyTPCC1 extends RecyclerView.Adapter<AdapterDauViecPhongChuTriChoXuLyTPCC1.ViewHolder> {
    private ArrayList<ItemDauViecPhongChuTriChoXuLyTCC> itemArrayList;
    OnItemClickListener listener;


    public AdapterDauViecPhongChuTriChoXuLyTPCC1(ArrayList<ItemDauViecPhongChuTriChoXuLyTCC> itemArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ItemDauViecPhongChuTriChoXuLyTCC giaHanGiaiQuyet = itemArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC);

        void onItemClickXuLy(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC);

        void onItemClickXemChiTiet(ItemDauViecPhongChuTriChoXuLyTCC itemDauViecPhongChuTriChoXuLyTCC);
    }
}
