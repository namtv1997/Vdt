...
import com.vpdt.vpdt.ui.activity.XuLyVanBan.NDVB_DSVB_QuaHanCuaPhongActivity;
...
public class DSVB_QuaHanCuaPhongFragment extends BaseFragment<DSVB_QuaHanDoLanhDaoChiDao_Presenter> implements DSVB_QuaHanDoLanhDaoChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_dsvb__qua_han_cua_phong;
    }
    ...
    public void onItemClickXemFile(DSVB_QuaHan dsvb_quaHan) {
        if (dsvb_quaHan.getTaiLieus().size() == 0) {
    ...
    public void onItemClickXuLy(DSVB_QuaHan dsvb_quaHan) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVB_DSVB_QuaHanCuaPhongActivity.class);
