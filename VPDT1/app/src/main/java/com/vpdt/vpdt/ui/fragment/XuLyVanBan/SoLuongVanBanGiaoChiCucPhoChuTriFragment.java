...
public class SoLuongVanBanGiaoChiCucPhoChuTriFragment extends BaseFragment<SoLuongVanBanGiaoChiCucPhoChuTri_Presenter> implements SoLuongVanBanGiaoChiCucPhoChuTriView,
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBGiaoPhongChuTriCC(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBGiaoPhongChuTriCC(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBGiaoPhongChuTriCC(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBGiaoPhongChuTriCC(String.valueOf(integer), true);
