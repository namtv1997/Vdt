...
public class TTVBSoLuongVanBanGiaoPhongChuTri1Activity extends BaseActivity<TTVB_DSVBDaHoanThanhChoLDPhongPheDuyetPresenter>
    ...
    @BindView(R.id.rlVanBanDi)
    RelativeLayout rlVanBanDi;
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbso_luong_van_ban_giao_phong_chu_tri1;
    }
    ...
    @OnClick({R.id.imvBack, R.id.tvThongTinVanBan,
            ...
            R.id.tvTrinhTuHoanThanhCV, R.id.tvVanBanDi})
    ...
    public void onGetDaTaSuccess(DetailVanBanChoLanhDaoPhongPheDuyet detailVanBanChoLanhDaoPhongPheDuyet) {
        ...
        RecyclerViewKVanBanDiSoLuongVanBanGiaoPhongChuTri((ArrayList<VanBanDiChoLanhDaoPhongPheDuyet>) detailVanBanChoLanhDaoPhongPheDuyet.getVanBanDis());
        ...
        if (detailVanBanChoLanhDaoPhongPheDuyet.getVanBanDis().size() == 0) {
            rlVanBanDi.setVisibility(View.GONE);
            lnVanBanDi.setVisibility(View.GONE);
        }
