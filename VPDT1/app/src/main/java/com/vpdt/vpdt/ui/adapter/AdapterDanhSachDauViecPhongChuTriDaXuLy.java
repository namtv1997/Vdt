...
public class AdapterDanhSachDauViecPhongChuTriDaXuLy extends RecyclerView.Adapter<AdapterDanhSachDauViecPhongChuTriDaXuLy.ViewHolder> implements AdapterDauViecPhongChuTriDaChiDaoChuaHT.OnItemClickListener {
    ...
    public AdapterDanhSachDauViecPhongChuTriDaXuLy(Context context, ArrayList<DanhSachDauViecPhongChuTriDaChiDaoChuaHT> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
