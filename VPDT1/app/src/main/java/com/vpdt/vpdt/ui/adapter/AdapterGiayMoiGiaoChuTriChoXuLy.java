...
public class AdapterGiayMoiGiaoChuTriChoXuLy extends RecyclerView.Adapter<AdapterGiayMoiGiaoChuTriChoXuLy.ViewHolder> {
    private ArrayList<GiayMoiGiaoChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList;
    private OnItemClickListener listener;


    public AdapterGiayMoiGiaoChuTriChoXuLy(ArrayList<GiayMoiGiaoChuTriChoXuLy> giayMoiChoLanhDaoXuLyArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiGiaoChuTriChoXuLy giaHanGiaiQuyet = giayMoiChoLanhDaoXuLyArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiGiaoChuTriChoXuLy giayMoiGiaoChuTriChoXuLy);

        void onItemClickXuLy(GiayMoiGiaoChuTriChoXuLy giayMoiGiaoChuTriChoXuLy);

        void onItemClickXemChiTiet(GiayMoiGiaoChuTriChoXuLy giayMoiGiaoChuTriChoXuLy);
    }
}
