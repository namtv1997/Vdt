...
import com.vpdt.vpdt.ui.activity.VanBanDonViCapHai.NDVBVanBanChoChiDaoLV2Activity;
...
public class VanBanChoChiDaoLV2Fragment extends BaseFragment<VanBanChoChiDaoLV2Presenter> implements VanBanChoChiDaoLV2View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_vanbanchochidaolv2;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBChoChiDaoDonViCapHaiPhong(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBChoChiDaoDonViCapHaiPhong(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBChoChiDaoDonViCapHaiPhong(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBChoChiDaoDonViCapHaiPhong(String.valueOf(integer), true);
    ...
    public void onItemClickXuLy(VanBanChoChiDaoLV2 vanBanChoChiDaoLV2) {
        if (!click) {
            Intent intent = new Intent(getActivity(), NDVBVanBanChoChiDaoLV2Activity.class);
