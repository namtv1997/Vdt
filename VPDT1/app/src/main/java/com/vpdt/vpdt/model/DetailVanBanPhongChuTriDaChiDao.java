...
public class DetailVanBanPhongChuTriDaChiDao {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @Expose
    private List<TrinhTuGiaiQuyetVanBanChuTri> trinhTuGiaiQuyets = null;
    ...
    public List<TrinhTuGiaiQuyetVanBanChuTri> getTrinhTuGiaiQuyets() {
        return trinhTuGiaiQuyets;
    }

    public void setTrinhTuGiaiQuyets(List<TrinhTuGiaiQuyetVanBanChuTri> trinhTuGiaiQuyets) {
