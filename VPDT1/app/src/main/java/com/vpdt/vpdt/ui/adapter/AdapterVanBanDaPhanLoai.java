...
public class AdapterVanBanDaPhanLoai extends RecyclerView.Adapter<AdapterVanBanDaPhanLoai.ViewHolder> {
    private ArrayList<VanBanDaPhanLoai> dsvb_quaHanArrayList;
    private OnItemClickListener listener;


    public AdapterVanBanDaPhanLoai(ArrayList<VanBanDaPhanLoai> dsvb_quaHanArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanDaPhanLoai giaHanGiaiQuyet = dsvb_quaHanArrayList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanDaPhanLoai vanBanDaPhanLoai);

        void onItemClickXuLy(VanBanDaPhanLoai vanBanDaPhanLoai);

        void onItemClickXemChiTiet(VanBanDaPhanLoai vanBanDaPhanLoai);
    }
}
