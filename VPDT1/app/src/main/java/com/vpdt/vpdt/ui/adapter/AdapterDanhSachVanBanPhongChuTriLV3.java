...
public class AdapterDanhSachVanBanPhongChuTriLV3 extends RecyclerView.Adapter<AdapterDanhSachVanBanPhongChuTriLV3.ViewHolder> {
    private ArrayList<DanhSachvanBanPhongChuTriLV3> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterDanhSachVanBanPhongChuTriLV3(ArrayList<DanhSachvanBanPhongChuTriLV3> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        DanhSachvanBanPhongChuTriLV3 giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
...
//        } else {
//            viewHolder.tvHanXuLy.setText(String.valueOf("Hạn giải quyết: "+giaHanGiaiQuyet.getSoKyHieu()));
//        }
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(DanhSachvanBanPhongChuTriLV3 danhSachvanBanPhongChuTriLV3);

        void onItemClickXuLy(DanhSachvanBanPhongChuTriLV3 danhSachvanBanPhongChuTriLV3);

        void onItemClickXemChiTiet(DanhSachvanBanPhongChuTriLV3 danhSachvanBanPhongChuTriLV3);
    }
}
