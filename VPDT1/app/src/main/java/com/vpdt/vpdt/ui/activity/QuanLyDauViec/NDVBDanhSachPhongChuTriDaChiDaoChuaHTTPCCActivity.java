...
public class NDVBDanhSachPhongChuTriDaChiDaoChuaHTTPCCActivity extends BaseActivity<NDVBDauViecPhongChuTriChoXuLyTPCCPresenter> implements NDVBDauViecPhongChuTriChoXuLyViewTPCC,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbdanh_sach_phong_chu_tri_da_chi_dao_chua_httpcc;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvNgayThangNam:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetDauViecPhongChuTriChoXuLyTPCC(PrefUtil.getString(NDVBDanhSachPhongChuTriDaChiDaoChuaHTTPCCActivity.this, Key.NAM_LAM_VIEC, ""),
