...
public class TTVBDSVBChoSoCuaSoActivity extends BaseActivity<TTVBVanBanTrinhKyPresenter> implements TTVBVanBanTrinhKyView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ttvbdsvbcho_so_cua_so;
    }
    ...
    public void initializeComponents() {
        ...
        if (intent != null) {
            if (intent.hasExtra("ID_VANBAN_CHOSOCUASO")) {
                idvb = intent.getIntExtra("ID_VANBAN_CHOSOCUASO", 0);
