...
public class NDVBVanBanDaChiDaoPhongChuaXuLyLV2Activity extends BaseActivity<NDVBVanBanChoChiDaoPresenter> implements NDVBVanBanChoChiDaoView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_da_chi_dao_phong_chua_xu_ly_lv2;
    }
    ...
    public void initializeComponents() {
        ...
        VanBanChoChiDaoLV2 vanBanPhoiHopDaChiDao = getIntent().getParcelableExtra("vanBanChoChiDaoLV2");
        ...
        if (vanBanPhoiHopDaChiDao != null) {
            ...
            tvPhong.setText(String.valueOf(vanBanPhoiHopDaChiDao.getTenPhongChuTri()));
//            edtChiDao2.setText(String.valueOf(vanBanPhoiHopDaChiDao.get));
            ...
            if (vanBanPhoiHopDaChiDao.getGiayMoiGio().isEmpty() || vanBanPhoiHopDaChiDao.getGiayMoiGio() == null) {
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanDaChiDaoPhongChuaXuLyLV2Activity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    @OnClick({R.id.btnChonPhoiHop, R.id.tvNgayThangNam, R.id.lnNDVB_DSVB_DaChiDao, R.id.imvBack,
            R.id.btnDuyet, R.id.tvXemChiTiet, R.id.tvPhong})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBDaChiDaoPhongChuaXuLyDonViCapHaiPhong(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
