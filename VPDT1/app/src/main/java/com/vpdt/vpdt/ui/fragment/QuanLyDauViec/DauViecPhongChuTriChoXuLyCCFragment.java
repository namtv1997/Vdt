...
import com.vpdt.vpdt.ui.adapter.AdapterDauViecPhongChuTriChoXuLyCC;
...
public class DauViecPhongChuTriChoXuLyCCFragment extends BaseFragment<DauViecPhongChuTriChoXuLyCCPresenter> implements DauViecPhongChuTriChoXuLyCCView,
        AdapterNamLamViec.OnItemClickListenerNamLamViec, AdapterDauViecPhongChuTriChoXuLyCC.OnItemXemFileClickListener {
    ...
    AdapterDauViecPhongChuTriChoXuLyCC adapterDanhSachDauViecQuaHanCuaPhong;

    @Override
    public int getContentViewId() {
        return R.layout.fragment_dau_viec_phong_chu_tri_cho_xu_ly_cc;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllDauViecPhongChuTriChoXuLyCC(NamLamViec, true);
    ...
    public void onGetSuccess(ArrayList<DauViecPhongChuTriChoXuLy> dauViecPhongChuTriChoXuLyArrayList) {
        adapterDanhSachDauViecQuaHanCuaPhong = new AdapterDauViecPhongChuTriChoXuLyCC(getActivity(), dauViecPhongChuTriChoXuLyArrayList, this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerview.setLayoutManager(layoutManager);
        recyclerview.setAdapter(adapterDanhSachDauViecQuaHanCuaPhong);
        if (dauViecPhongChuTriChoXuLyArrayList.size() == 0) {
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllDauViecPhongChuTriChoXuLyCC(String.valueOf(integer), true);
    ...
    @Override
    public void onItemClickXemFile(DauViecPhongChuTriChoXuLy dauViecPhongChuTriChoXuLy) {
        try {
