...
public class NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity extends BaseActivity<NDVBSoLuongVanBanGiaoPhongChuTriPresenter> implements NDVBSoLuongVanBanGiaoPhongChuTriView,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbso_luong_van_ban_giao_chi_cuc_pho_chu_tri;
    }
    ...
    public void initializeComponents() {
        ...
        SoLuongVanBanGiaoChiCucPhoChuTri soLuongVanBanGiaoPhongChuTri = getIntent().getParcelableExtra("soLuongVanBanGiaoPhongChuTri");
        if (soLuongVanBanGiaoPhongChuTri != null) {
            ...
            if (!soLuongVanBanGiaoPhongChuTri.getGiayMoiGio().isEmpty() && !soLuongVanBanGiaoPhongChuTri.getGiayMoiNgay().isEmpty() && !soLuongVanBanGiaoPhongChuTri.getGiayMoiDiaDiem().isEmpty()) {
                ...
                tvXemChiTietNDVBDSVBDenChoLDXL.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!click) {
                            Intent intent = new Intent(NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this, TTVBSoLuongVanBanGiaoPhongChuTriActivity.class);
                ...
                tvXemChiTietNDVBDSVBDenChoLDXL.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!click) {
                            Intent intent = new Intent(NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this, TTVBSoLuongVanBanGiaoPhongChuTri1Activity.class);
                            intent.putExtra("idvb", idvb);
                            startActivity(intent);
                            click = true;
                        }
            ...
            tvNgayKy.setText(soLuongVanBanGiaoPhongChuTri.getNgayKy());
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            btnTuChoi.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder buildertuchoi = new AlertDialog.Builder(NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this);
                    LayoutInflater inflatertuchoi = (LayoutInflater) NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                        ...
                        public void onClick(View v) {
                            if (soLuongVanBanGiaoPhongChuTri.getTypeTuChoi() == 1) {
                                if (edtNoiDungTuChoi.getText().toString().isEmpty()) {
                                    Toast.makeText(NDVBSoLuongVanBanGiaoChiCucPhoChuTriActivity.this, "Chưa nhập nội dung từ chối", Toast.LENGTH_SHORT).show();
                                } else {
