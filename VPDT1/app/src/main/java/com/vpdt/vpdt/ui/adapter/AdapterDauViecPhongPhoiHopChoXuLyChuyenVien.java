...
public class AdapterDauViecPhongPhoiHopChoXuLyChuyenVien extends RecyclerView.Adapter<AdapterDauViecPhongPhoiHopChoXuLyChuyenVien.ViewHolder> implements AdapterDauViecPhongChuTriChuyenVienChoXuLy.OnItemClickListener {
    ...
    public AdapterDauViecPhongPhoiHopChoXuLyChuyenVien(Context context, ArrayList<PhongChuTriChuyenVienChoXuLy> baoCaoTongHopArrayList, OnItemXemFileClickListener listener) {
