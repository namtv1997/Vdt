...
public class AdapterNguoiKyVB extends RecyclerView.Adapter<AdapterNguoiKyVB.ViewHolder> {
    private ArrayList<KhuVuc> khuVucArrayList;
    private OnItemNguoiKyVBClickListener listener;

    public AdapterNguoiKyVB(ArrayList<KhuVuc> khuVucArrayList, OnItemNguoiKyVBClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onItemNguoiKyVBClick(khuVucArrayList.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemNguoiKyVBClickListener {
        void onItemNguoiKyVBClick(KhuVuc khuVuc);
    }
}
