...
public class AdapterDanhSachVanBanTongThe extends RecyclerView.Adapter<AdapterDanhSachVanBanTongThe.ViewHolder> {
    private ArrayList<VanBanTongTheDonViCapHai> vbPhoPhongPhoiHopChoXLArrayList;

    private OnItemClickListener listener;


    public AdapterDanhSachVanBanTongThe(ArrayList<VanBanTongTheDonViCapHai> vbPhoPhongPhoiHopChoXLArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        VanBanTongTheDonViCapHai giaHanGiaiQuyet = vbPhoPhongPhoiHopChoXLArrayList.get(position);
        ...
        viewHolder.tvnoigui.setText(String.valueOf(giaHanGiaiQuyet.getNoiGuiDen()));
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(VanBanTongTheDonViCapHai vanBanTongTheDonViCapHai);

        void onItemClickXuLy(VanBanTongTheDonViCapHai vanBanTongTheDonViCapHai);

        void onItemClickXemChiTiet(VanBanTongTheDonViCapHai vanBanTongTheDonViCapHai);
    }
}
