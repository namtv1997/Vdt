...
public class AdapterGiayMoiDaPhanLoai extends RecyclerView.Adapter<AdapterGiayMoiDaPhanLoai.ViewHolder> {
    private ArrayList<GiayMoiDaPhanLoai> ToCongTacList;
    private OnItemClickListener listener;


    public AdapterGiayMoiDaPhanLoai(ArrayList<GiayMoiDaPhanLoai> ToCongTacList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        GiayMoiDaPhanLoai giaHanGiaiQuyet = ToCongTacList.get(position);
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(GiayMoiDaPhanLoai giayMoiDaPhanLoai);

        void onItemClickXuLy(GiayMoiDaPhanLoai giayMoiDaPhanLoai);

        void onItemClickXemChiTiet(GiayMoiDaPhanLoai giayMoiDaPhanLoai);
    }
}
