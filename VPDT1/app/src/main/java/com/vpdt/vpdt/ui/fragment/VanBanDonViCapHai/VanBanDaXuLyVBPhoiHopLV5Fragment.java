...
public class VanBanDaXuLyVBPhoiHopLV5Fragment extends BaseFragment<VanBanChoXuLyVBChuTriLV5Presenter> implements VanBanChoXuLyVBChuTriLV5View,
    ...
    public int getContentViewId() {
        return R.layout.fragment_van_ban_da_xu_ly_vb_phoi_hop_lv5;
    }
    ...
    public void onStart() {
        ...
        getPresenter().getAllVBDaXuLyCVPhoiHopDonViCapHai(NamLamViec, true);
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                getPresenter().getAllVBDaXuLyCVPhoiHopDonViCapHai(NamLamViec, false);
            }
        };
    ...
    public void onGetDataSuccess() {
        ...
        getPresenter().countAllVBDaXuLyCVPhoiHopDonViCapHai(NamLamViec);
    }
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        getPresenter().getAllVBDaXuLyCVPhoiHopDonViCapHai(String.valueOf(integer), true);
