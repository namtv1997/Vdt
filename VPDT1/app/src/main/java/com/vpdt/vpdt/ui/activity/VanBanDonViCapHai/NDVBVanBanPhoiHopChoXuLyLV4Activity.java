...
public class NDVBVanBanPhoiHopChoXuLyLV4Activity extends BaseActivity<NDVBVanBanChoXuLyLV4Presenter> implements NDVBVanBanChoXuLyLV4View,
    ...
    public int getContentViewId() {
        return R.layout.activity_ndvbvan_ban_phoi_hop_cho_xu_ly_lv4;
    }
    ...
    public void initializeComponents() {
        ...
        VanBanPhoiHopChoXuLyLV4 vanBanPhoiHopDaChiDao = getIntent().getParcelableExtra("vanBanPhoiHopChoXuLyLV4");
        ...
        if (vanBanPhoiHopDaChiDao != null) {
            ...
            CT_PH = vanBanPhoiHopDaChiDao.getCTPH();
            ...
            tvFileDinhKem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(NDVBVanBanPhoiHopChoXuLyLV4Activity.this, "Lỗi hệ thống!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvXemChiTiet:
                ...
                break;
            case R.id.btnDuyet:
                getPresenter().duyetVBPhoiHopChoXuLyDonViCapHai(PrefUtil.getString(this, Key.NAM_LAM_VIEC, ""),
                        id, CT_PH, idChuyenVienPhoiHops, edtChiDao4.getText().toString(), tvNgayThangNam.getText().toString());
                break;
        }
    }
