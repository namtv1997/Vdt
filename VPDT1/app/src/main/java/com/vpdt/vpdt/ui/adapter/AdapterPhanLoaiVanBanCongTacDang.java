...
public class AdapterPhanLoaiVanBanCongTacDang extends RecyclerView.Adapter<AdapterPhanLoaiVanBanCongTacDang.ViewHolder> {
    private ArrayList<PhanLoaiVanBanCongTacDang> dsvb_quaHanArrayList;
    private OnItemClickListener listener;


    public AdapterPhanLoaiVanBanCongTacDang(ArrayList<PhanLoaiVanBanCongTacDang> dsvb_quaHanArrayList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        PhanLoaiVanBanCongTacDang giaHanGiaiQuyet = dsvb_quaHanArrayList.get(position);
...
//        if (giaHanGiaiQuyet.getLoaiVanBan().isEmpty() || giaHanGiaiQuyet.getl() == null) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(PhanLoaiVanBanCongTacDang phanLoaiVanBanCongTacDang);

        void onItemClickXuLy(PhanLoaiVanBanCongTacDang phanLoaiVanBanCongTacDang);

        void onItemClickXemChiTiet(PhanLoaiVanBanCongTacDang phanLoaiVanBanCongTacDang);
    }
}
