...
public class AdapterDonVi extends RecyclerView.Adapter<AdapterDonVi.ViewHolder> {
    ...
    private OnItemDonViClickListener listener;

    public AdapterDonVi(ArrayList<KhuVuc> khuVucArrayList, OnItemDonViClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.onItemDonViClick(khuVucArrayList.get(position));
                }
            }
        });
    }
    ...
    public interface OnItemDonViClickListener {
        void onItemDonViClick(KhuVuc khuVuc);
    }
}
