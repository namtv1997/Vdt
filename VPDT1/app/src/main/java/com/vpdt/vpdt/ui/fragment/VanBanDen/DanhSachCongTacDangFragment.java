...
public class DanhSachCongTacDangFragment extends BaseFragment<DanhSachCongTacDangPresenter> implements DanhSachCongTacDangView,
    ...
    public int getContentViewId() {
        return R.layout.fragment_danh_sach_cong_tac_dang;
    }
    ...
    public void onStart() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().getallvbdentongthe(1, 0, NamLamViec, true);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().getallvbdentongthe(1, 1, NamLamViec, true);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().getallvbdentongthe(1, 2, NamLamViec, true);
        }
        ...
        scrollListener = new EndlessRecyclerViewScrollListener(layoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (TenVB.getText() == "-- Tất cả --") {
                    getPresenter().getallvbdentongthe(1, 0, NamLamViec, false);
                } else if (TenVB.getText() == "Văn bản mới nhập") {
                    getPresenter().getallvbdentongthe(1, 1, NamLamViec, false);
                } else if (TenVB.getText() == "Đã giải quyết") {
                    getPresenter().getallvbdentongthe(1, 2, NamLamViec, false);
                }
    ...
    public void onGetDataSuccess() {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().countvbden(1, 0, NamLamViec);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().countvbden(1, 1, NamLamViec);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().countvbden(1, 2, NamLamViec);
        }
    }
    ...
    @OnClick({R.id.TenVB, R.id.btnBack, R.id.vdsctd, R.id.lndsctd, R.id.rldsctd, R.id.btnNamLamViec, R.id.btnHome})
    ...
    public void onItemClickNamLamViec(Integer integer) {
        ...
        if (TenVB.getText() == "-- Tất cả --") {
            getPresenter().getallvbdentongthe(1, 0, String.valueOf(integer), true);
        } else if (TenVB.getText() == "Văn bản mới nhập") {
            getPresenter().getallvbdentongthe(1, 1, String.valueOf(integer), true);
        } else if (TenVB.getText() == "Đã giải quyết") {
            getPresenter().getallvbdentongthe(1, 2, String.valueOf(integer), true);
        }
