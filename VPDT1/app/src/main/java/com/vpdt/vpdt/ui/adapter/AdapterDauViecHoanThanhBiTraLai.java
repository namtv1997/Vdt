...
public class AdapterDauViecHoanThanhBiTraLai extends RecyclerView.Adapter<AdapterDauViecHoanThanhBiTraLai.ViewHolder> {
    private ArrayList<DauViecHoanThanhBiTraLai> dauViecHoanThanhBiTraLaiArrayList;
    private OnItemClickListener listener;


    public AdapterDauViecHoanThanhBiTraLai(ArrayList<DauViecHoanThanhBiTraLai> dauViecHoanThanhBiTraLaiArrayList, OnItemClickListener listener) {
        this.dauViecHoanThanhBiTraLaiArrayList = dauViecHoanThanhBiTraLaiArrayList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        DauViecHoanThanhBiTraLai giaHanGiaiQuyet = dauViecHoanThanhBiTraLaiArrayList.get(position);
...
//        if (giaHanGiaiQuyet.geth().isEmpty() || giaHanGiaiQuyet.getHanXuLy() == null) {
...
//        if (giaHanGiaiQuyet.getNoiDungChiDao().isEmpty() || giaHanGiaiQuyet.getNoiDungChiDao() == null) {
...
//        }
        ...
        viewHolder.btnXemFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (dauViecHoanThanhBiTraLaiArrayList.size() > 0) {
                        listener.onItemClickXemFile(dauViecHoanThanhBiTraLaiArrayList.get(position));
                    }
                }
            }
        });
        viewHolder.btnXuLy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (dauViecHoanThanhBiTraLaiArrayList.size() > 0) {
                        listener.onItemClickXuLy(dauViecHoanThanhBiTraLaiArrayList.get(position));
                    }
                }
            }
        });
        ...
        viewHolder.btnXemChiTiet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    if (dauViecHoanThanhBiTraLaiArrayList.size() > 0) {
                        listener.onItemClickXemChiTiet(dauViecHoanThanhBiTraLaiArrayList.get(position));
                    }
                }
            }
        });
    ...
    public int getItemCount() {
        return dauViecHoanThanhBiTraLaiArrayList.size();
    }
    ...
    public interface OnItemClickListener {
        void onItemClickXemFile(DauViecHoanThanhBiTraLai dauViecHoanThanhBiTraLai);

        void onItemClickXuLy(DauViecHoanThanhBiTraLai dauViecHoanThanhBiTraLai);

        void onItemClickXemChiTiet(DauViecHoanThanhBiTraLai dauViecHoanThanhBiTraLai);
    }
}
